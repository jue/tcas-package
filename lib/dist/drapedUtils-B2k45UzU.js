import { c1 as C, b1 as W, a as u, b as c, i1 as K, dI as X, aC as N, a9 as Y, cQ as ee, c as M, bk as Q, g0 as te, m as A, bl as re, cU as se, fd as ie, ae as ne, b3 as oe, M as ae, w as le, H as T, V as ue, R as U, fP as pe, cy as L, fz as ye, aE as V, z as ce, i2 as fe, T as he, ey as de } from "./index-B7TsCcH6.js";
import { i as me, r as ge } from "./scaleUtils-2jFMtUZp.js";
import { n as _ } from "./floorFilterUtils-EbR9s7nP.js";
import { b as be } from "./normalizeUtils-Le73uFr2.js";
import { f as we, s as ve, i as xe } from "./utils-iTYrz_MZ.js";
import { n as $e } from "./sublayerUtils-4nG-Ec5e.js";
import { n as Se, p as Re } from "./popupUtils-siDvgqb0.js";
function I(e, t) {
    ...
    if (s && i)
      for (const r of e) {
        ...
        r.sourceLayer && "geometryType" in r.sourceLayer && r.sourceLayer.geometryType === "point" && n && "getSymbolAsync" in n && n.getSymbolAsync(r).then(async (o) => {
          ...
          y && (P || (P = (await import("./index-B7TsCcH6.js").then((p) => p.lD)).getSize), a = P(y, r, { view: t.type, scale: t.scale, shape: o.type === "simple-marker" ? o.style : null })), a || (a = "width" in o && "height" in o && o.width != null && o.height != null ? Math.max(o.width, o.height) : "size" in o ? o.size : 16), s.includes(r) && (r.symbol = new L({ style: "square", size: a, xoffset: "xoffset" in o ? o.xoffset : 0, yoffset: "yoffset" in o ? o.yoffset : 0 }), i(r, "symbol"), r.visible = !0);
        });
      }
  }
