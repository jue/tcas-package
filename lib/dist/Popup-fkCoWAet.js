...
let de = class extends Be {
  ...
  loadDependencies() {
    return ni({ icon: () => import("./calcite-icon-ZyQqmJRE.js") });
  }
  get capabilities() {
...
async function zo(s, e, t) {
  ...
  return (await Promise.all(r.map(async (h, f) => ({ value: h, color: s.type === "opacity" ? await Vo(h, s, e) : (await import("./index-HxXrdrYt.js").then((c) => c.lD)).getColor(s, h), label: i ? n[f] : (l == null ? void 0 : l[f]) ?? "" })))).reverse();
}
async function Vo(s, e, t) {
  const i = new Zr(t ?? No), r = (await import("./index-HxXrdrYt.js").then((n) => n.lD)).getOpacity(e, s);
...
let ue = class extends Be {
  ...
  async _getRendererColors() {
    const { colorAm5: e } = await import("./chartCommon-A4__EYJ0.js"), t = /* @__PURE__ */ new Map(), i = this._getRenderer(), r = "default";
    if (!i)
      return t;
    const n = await Uo(i);
  ...
  async _renderChart(e) {
    const { root: t, mediaInfo: i } = e, { value: r, type: n } = i, { ResponsiveThemeAm5: a, DarkThemeAm5: o, AnimatedThemeAm5: l, ColorSetAm5: h, ThemeAm5: f } = await import("./chartCommon-A4__EYJ0.js"), c = f.new(t);
  ...
  async _customizeChartTooltip(e, t = "horizontal") {
    var r;
    const { colorAm5: i } = await import("./chartCommon-A4__EYJ0.js");
  ...
  async _createPieChart(e, t) {
    const { TooltipAm5: i } = await import("./chartCommon-A4__EYJ0.js"), { PieChartAm5: r, PieSeriesAm5: n } = await import("./pieChart-86CnOErt.js"), { mediaInfo: a, root: o } = e, { title: l } = a, h = 5, f = (a == null ? void 0 : a.altText) || (a == null ? void 0 : a.title) || "", c = o.container.children.push(r.new(o, { ariaLabel: f, focusable: !0, paddingBottom: h, paddingTop: h, paddingLeft: h, paddingRight: h })), p = `{category}: {valuePercentTotal.formatNumber('0.00')}%
 ({value})`, d = i.new(o, { labelText: p }), _ = c.series.push(n.new(o, { name: l, valueField: jt, categoryField: qe, tooltip: d }));
  ...
  async _createColumnChart(e, t, i) {
    const { TooltipAm5: r, ScrollbarAm5: n } = await import("./chartCommon-A4__EYJ0.js"), { CategoryAxisAm5: a, AxisRendererXAm5: o, ValueAxisAm5: l, AxisRendererYAm5: h, ColumnSeriesAm5: f } = await import("./xyChart-UL8dtHfA.js"), { mediaInfo: c, root: p } = t, { value: d, title: _ } = c;
  ...
  async _createLineChart(e, t, i) {
    const { TooltipAm5: r, ScrollbarAm5: n } = await import("./chartCommon-A4__EYJ0.js"), { CategoryAxisAm5: a, AxisRendererXAm5: o, ValueAxisAm5: l, AxisRendererYAm5: h, LineSeriesAm5: f } = await import("./xyChart-UL8dtHfA.js"), { root: c, mediaInfo: p } = t, { value: d, title: _ } = p;
    e.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e, t) {
    const { XYChartAm5: i, XYCursorAm5: r } = await import("./xyChart-UL8dtHfA.js"), { root: n, mediaInfo: a } = e, { type: o } = a, l = (a == null ? void 0 : a.altText) || (a == null ? void 0 : a.title) || "", h = n.container.children.push(i.new(n, { ariaLabel: l, focusable: !0, panX: !0, panY: !0 }));
...
function zn() {
  return import("./arcadeUtils-I0RD6sdR.js").then((s) => s.az);
}
function gd(s) {
...
let pe = class extends Be {
  ...
  loadDependencies() {
    return ni({ icon: () => import("./calcite-icon-ZyQqmJRE.js"), list: () => import("./calcite-list-PNh7CPet.js"), "list-item": () => import("./calcite-list-item-lXbLS6Lg.js"), notice: () => import("./calcite-notice-CN_fiNqi.js") });
  }
  destroy() {
...
let se = Is = class extends Un(Be) {
  ...
  loadDependencies() {
    return ni({ notice: () => import("./calcite-notice-CN_fiNqi.js") });
  }
  destroy() {
...
async function Ld(s, e) {
  ...
  const { getColor: o, getOpacity: l, getAllSizes: h, getRotationAngle: f } = await import("./index-HxXrdrYt.js").then((w) => w.lD), c = [], p = [], d = [], _ = [];
...
let A = class extends Un(Be) {
  ...
  loadDependencies() {
    return ni({ action: () => import("./calcite-action-4uyTBvZF.js"), flow: () => import("./calcite-flow-j-XP6VU_.js"), "flow-item": () => import("./calcite-flow-item-yb-INZ1i.js"), icon: () => import("./calcite-icon-ZyQqmJRE.js"), tooltip: () => import("./calcite-tooltip-1-w_Ujcg.js") });
  }
  initialize() {
