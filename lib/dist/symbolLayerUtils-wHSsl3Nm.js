import { bo as p, y as n, r as c, C as h, bp as b, bq as d, ar as w, br as v } from "./index-j1oaLRcp.js";
import "vue";
let i = a();
function a() {
  return new p(50);
...
async function B(e, r) {
  if (!e.isPrimitive) {
    ...
    const f = await import("./objectResourceUtils-QFOCSmY_.js").then((m) => m.o), u = await f.fetch(o, { disableTextures: !0 });
