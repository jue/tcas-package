import { H as N } from "./index-B7TsCcH6.js";
import { S as l, E as i, L as v, A as S } from "./color-Xkczoxbf.js";
var r, n;
function q(t) {
  switch (t) {
    case "left":
...
(function(t) {
  t[t.Left = -1] = "Left", t[t.Center = 0] = "Center", t[t.Right = 1] = "Right";
})(r || (r = {})), function(t) {
  t[t.Top = 1] = "Top", t[t.Center = 0] = "Center", t[t.Bottom = -1] = "Bottom", t[t.Baseline = 2] = "Baseline";
}(n || (n = {}));
function Z(t, e, s) {
  const o = v.SIZE_FIELD_STOPS | v.SIZE_MINMAX_VALUE | v.SIZE_SCALE_STOPS | v.SIZE_UNIT_VALUE, a = (e & (S.FIELD_TARGETS_OUTLINE | S.MINMAX_TARGETS_OUTLINE | S.SCALE_TARGETS_OUTLINE | S.UNIT_TARGETS_OUTLINE)) >>> 4;
  return t === i.LINE && s.isOutline || t === i.FILL && U(s.symbologyType) ? o & a : o & ~a;
}
const T = 0, b = 8, X = 7, f = 8, z = 11, E = 11, M = 12, A = 13, I = 14, C = 15, B = 16, w = 17, _ = 18, O = 19, P = 20, F = 21, R = 26, D = Object.keys(l).filter((t) => typeof l[t] == "number").reduce((t, e) => ({ ...t, [e]: l[e] }), {});
function G(t) {
  return t === l.SIMPLE || t === l.OUTLINE_FILL_SIMPLE;
}
function U(t) {
  return t === l.OUTLINE_FILL || t === l.OUTLINE_FILL_SIMPLE;
}
function se(t) {
  return G(t.symbologyType);
}
function ie(t) {
  return U(t.symbologyType);
}
function re(t, e) {
  switch (t) {
    case i.FILL:
...
class c {
  ...
  get textureBinding() {
    return this.bits(T, b);
  }
  set textureBinding(e) {
    this.setBits(e, T, b);
  }
  get symbologyType() {
    return this.bits(F, R);
  }
  set symbologyType(e) {
    this.setBits(e, F, R);
  }
  get geometryTypeString() {
    switch (this.geometryType) {
      ...
      case i.LABEL:
        return "label";
      default:
        throw new N(`Unable to handle unknown geometryType: ${this.geometryType}`);
    }
  }
  setBit(e, s) {
    const o = 1 << e;
    s ? this._data |= o : this._data &= ~o;
  }
  bit(e) {
    return (this._data & 1 << e) >> e;
  }
  setBits(e, s, o) {
    for (let a = s, u = 0; a < o; a++, u++)
      this.setBit(a, (e & 1 << u) != 0);
  }
  bits(e, s) {
    let o = 0;
    for (let a = e, u = 0; a < s; a++, u++)
      o |= this.bit(a) << u;
    return o;
  }
  hasVV() {
  ...
  getVariation() {
    return { mapAligned: this.mapAligned, pattern: this.pattern, sdf: this.sdf, symbologyType: { value: l[this.symbologyType], options: D, namespace: "SYMBOLOGY_TYPE" } };
  }
  getVariationHash() {
    return this._data & ~(X & this.textureBinding);
  }
}
c.shared = new c(0);
const h = (t) => class extends t {
  ...
  setVV(e, s) {
    super.setVV(e, s);
    const o = Z(this.geometryType, e, s) & e;
    this.vvSizeMinMaxValue = !!(o & v.SIZE_MINMAX_VALUE), this.vvSizeFieldStops = !!(o & v.SIZE_FIELD_STOPS), this.vvSizeUnitValue = !!(o & v.SIZE_UNIT_VALUE), this.vvSizeScaleStops = !!(o & v.SIZE_SCALE_STOPS);
  }
}, x = (t) => class extends t {
  get vvRotation() {
    return this.bit(C) !== 0;
  ...
  setVV(e, s) {
    super.setVV(e, s), this.vvRotation = !s.isOutline && !!(e & v.ROTATION);
  }
}, m = (t) => class extends t {
  get vvColor() {
    return this.bit(A) !== 0;
...
class p extends m(L(h(c))) {
  static load(e) {
    const s = this.shared;
    return s.data = e, s;
  }
  static from(e) {
    const { symbologyType: s, vvFlags: o } = e, a = this.load(0);
    return a.geometryType = i.FILL, a.symbologyType = s, s !== l.DOT_DENSITY && a.setVV(o, e), a.data;
  }
  getVariation() {
...
class g extends m(L(x(h(c)))) {
  ...
  static from(e) {
    const { symbologyType: s, vvFlags: o } = e, a = this.load(0);
    return a.geometryType = i.MARKER, a.symbologyType = s, s !== l.HEATMAP && a.setVV(o, e), a.data;
  }
  getVariation() {
...
class d extends m(L(h(c))) {
  ...
  static from(e) {
    const s = this.load(0);
    return s.geometryType = i.LINE, s.symbologyType = e.symbologyType, s.setVV(e.vvFlags, e), s.data;
  }
  getVariation() {
    return { ...super.getVariation(), vvColor: this.vvColor, vvOpacity: this.vvOpacity, vvSizeFieldStops: this.vvSizeFieldStops, vvSizeMinMaxValue: this.vvSizeMinMaxValue, vvSizeScaleStops: this.vvSizeScaleStops, vvSizeUnitValue: this.vvSizeUnitValue };
  }
...
class y extends m(L(x(h(c)))) {
  ...
  static from(e) {
    const s = this.load(0);
    return s.geometryType = i.TEXT, s.symbologyType = e.symbologyType, s.setVV(e.vvFlags, e), s.data;
  }
  getVariation() {
...
class V extends h(c) {
  ...
  static from(e) {
    const s = this.load(0);
    return s.geometryType = i.LABEL, s.symbologyType = e.symbologyType, s.setVV(e.vvFlags, e), s.mapAligned = $(e.placement), s.data;
  }
  getVariation() {
