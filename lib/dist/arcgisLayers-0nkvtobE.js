import { G as v, H as h, I as O, J as L, L as T, K as b } from "./index-h53IWweP.js";
import { t as d, r as P } from "./fetchService-mFN0xIKm.js";
import { a as g } from "./lazyLayerLoader-I7o9QNli.js";
import "vue";
...
async function R(r) {
  ...
  const s = new (await import("./GroupLayer-fOeHnMxy.js")).default({ title: e.parsedUrl.title });
  return F(s, e, a), s;
}
function S(r, l) {
