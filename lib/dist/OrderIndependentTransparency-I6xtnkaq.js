import { N as p, S as f, T as _, R as r, I as c } from "./enums-Vyj7xNgv.js";
import { n as u } from "./basicInterfaces-qgybO4Nz.js";
...
function N(t, e, n, i, h = _.ADD, C = _.ADD, a = [0, 0, 0, 0]) {
  return { srcRgb: t, srcAlpha: e, dstRgb: n, dstAlpha: i, opRgb: h, opAlpha: C, color: { r: a[0], g: a[1], b: a[2], a: a[3] } };
}
const R = { face: p.BACK, mode: f.CCW }, y = { face: p.FRONT, mode: f.CCW }, Y = (t) => t === u.Back ? R : t === u.Front ? y : null, tt = { zNear: 0, zFar: 1 }, et = { r: !0, g: !0, b: !0, a: !0 };
function D(t) {
  return B.intern(t);
}
function $(t) {
...
const z = new s(S, (t) => ({ __tag: "Culling", ...t }));
function S(t) {
  return t ? l([t.face, t.mode]) : null;
}
const L = new s(I, (t) => ({ __tag: "PolygonOffset", ...t }));
function I(t) {
  return t ? l([t.factor, t.units]) : null;
}
const M = new s(W, (t) => ({ __tag: "DepthTest", ...t }));
function W(t) {
  return t ? l([t.func]) : null;
}
const U = new s(T, (t) => ({ __tag: "StencilTest", ...t }));
function T(t) {
...
const x = new s(Q, (t) => ({ blending: D(t.blending), culling: $(t.culling), polygonOffset: m(t.polygonOffset), depthTest: F(t.depthTest), stencilTest: P(t.stencilTest), depthWrite: E(t.depthWrite), colorWrite: w(t.colorWrite), stencilWrite: k(t.stencilWrite) }));
function Q(t) {
  return t ? l([v(t.blending), S(t.culling), I(t.polygonOffset), W(t.depthTest), T(t.stencilTest), b(t.depthWrite), O(t.colorWrite), A(t.stencilWrite)]) : null;
}
class st {
  constructor(e) {
...
const rt = N(r.SRC_ALPHA, r.ONE, r.ONE_MINUS_SRC_ALPHA, r.ONE_MINUS_SRC_ALPHA), q = g(r.ONE, r.ONE), G = g(r.ZERO, r.ONE_MINUS_SRC_ALPHA);
function ot(t) {
  return t === o.FrontFace ? null : t === o.Alpha ? G : q;
}
const at = 5e5, J = { factor: -1, units: -2 };
function ht(t) {
  return t ? J : null;
}
function _t(t, e = c.LESS) {
  return t === o.NONE || t === o.FrontFace ? e : c.LEQUAL;
}
export {
  ot as A,
  st as M,
