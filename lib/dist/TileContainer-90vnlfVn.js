import { z as i } from "./index-O2RTvw_o.js";
import { T as n } from "./color-etN3NLwm.js";
import { i as l, c as a, p as o } from "./WGLContainer-Onm3yFPW.js";
...
class u extends l {
  ...
  prepareRenderPasses(e) {
    ...
    return r.push(e.registerRenderPass({ name: "stencil", brushes: [a], drawPhase: n.DEBUG | n.MAP | n.HIGHLIGHT, target: () => this.getStencilTarget() })), i("geoscene-tiles-debug") && r.push(e.registerRenderPass({ name: "tileInfo", brushes: [o], drawPhase: n.DEBUG, target: () => this.children })), r;
  }
  getStencilTarget() {
