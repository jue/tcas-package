import { eg as q, a9 as O } from "./index-O2RTvw_o.js";
import { p as K, m as Q, y as W } from "./MeshLocalVertexSpace-DHMCPNMn.js";
import { m as X } from "./MeshGeoreferencedRelativeVertexSpace-Ez5kQ46e.js";
import { n as Z, s as ee } from "./vec32-O_nnmMb-.js";
...
function te() {
  return P || (P = new Promise((e) => import("./i3s-MwLGuZb-.js").then((t) => t.i).then(({ default: t }) => {
...
async function we(e) {
  ...
  if (m.type === "georeferenced") {
    const { projectBuffer: l, initializeProjection: g } = await import("./index-O2RTvw_o.js").then((c) => c.lC);
    await g(i, d), f = new Float64Array(a.length), l(a, i, 0, f, d, 0, f.length / 3);
  } else {
    const { project: l } = await import("./georeference-1nF-51XC.js").then((g) => g.c);
