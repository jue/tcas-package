import { fD as a, dq as d, an as h, fE as y, fF as S, fG as M, fH as g } from "./index-h53IWweP.js";
import { f as C, u as I, M as z, y as L, m as j } from "./utils-m9Kp97Du.js";
function x(o) {
  const t = [];
...
async function O(o) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-t2mDUGDk.js"), n = await t(o, 10), { width: l, height: e, depth: r } = o, c = [l, r, e];
  let f = 1;
  for (let i = 0; i < 3; i++) {
    const b = c[i];
    if (b != null) {
