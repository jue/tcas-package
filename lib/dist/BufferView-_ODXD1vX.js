import { hm as G, hf as H } from "./index-j1oaLRcp.js";
import { r as _ } from "./vec4-ehH7P-M2.js";
let q = class {
  ...
  getMat(e, t) {
    ...
    for (let r = 0; r < 9; r++)
      t[r] = this.typedBuffer[s++];
    return t;
  }
  setMat(e, t) {
    let s = e * this.typedBufferStride;
    for (let r = 0; r < 9; r++)
      this.typedBuffer[s++] = t[r];
  }
  get(e, t) {
...
class c {
  constructor(e, t, s = 0, r, i) {
    this.TypedArrayConstructor = e, this.elementCount = 4;
    const f = this.TypedArrayConstructor;
