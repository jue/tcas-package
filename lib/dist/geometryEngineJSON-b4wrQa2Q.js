import { G as r } from "./geometryEngineBase-20MeCuAD.js";
import { t as i } from "./json-uwIaZKlZ.js";
function l(e) {
...
function v(e, n, t, u, o, c, f) {
  return r.offset(i, e, n, t, u, o, c, f);
}
function z(e, n, t, u, o = !1) {
  return r.buffer(i, e, n, t, u, o);
}
function I(e, n, t, u, o, c, f) {
  return r.geodesicBuffer(i, e, n, t, u, o, c, f);
}
...
const W = Object.freeze(Object.defineProperty({ __proto__: null, buffer: z, changeDefaultSpatialReferenceTolerance: K, clearDefaultSpatialReferenceTolerance: N, clip: a, contains: p, convexHull: T, crosses: d, cut: s, densify: O, difference: E, disjoint: S, distance: g, equals: m, extendedSpatialReferenceInfo: l, flipHorizontal: q, flipVertical: B, generalize: C, geodesicArea: k, geodesicBuffer: I, geodesicDensify: G, geodesicLength: F, intersect: V, intersectLinesToPoints: J, intersects: h, isSimple: D, nearestCoordinate: j, nearestVertex: H, nearestVertices: _, offset: v, overlaps: R, planarArea: M, planarLength: $, relate: w, rotate: P, simplify: A, symmetricDifference: L, touches: x, union: b, within: y }, Symbol.toStringTag, { value: "Module" }));
export {
  b as A,
  M as B,
  F as C,
