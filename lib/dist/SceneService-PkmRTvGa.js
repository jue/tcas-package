import { r as _, C as f, y as u, f1 as $, de as L, bc as M, ev as K, s as V, e as c, d, bI as k, m as I, aE as m, M as x, eJ as q, bK as F, bD as C, a as z, X as J, f2 as D, L as B, f3 as Z, f4 as G, f5 as H, R as A, c1 as X, aa as E } from "./index-j1oaLRcp.js";
import { r as N } from "./originUtils-coUxWAIW.js";
import { getSiblingOfSameTypeI as Q } from "./resourceUtils-dtS02Sh0.js";
  ...
  let s = class extends i {
    ...
    async _validateAgainstJSONSchema(e, t, a) {
      ...
      if (a && a.validationOptions.ignoreUnsupported && (r = r.filter((o) => o.name !== "layer:unsupported" && o.name !== "symbol:unsupported" && o.name !== "symbol-layer:unsupported" && o.name !== "property:unsupported" && o.name !== "url:unsupported" && o.name !== "scenemodification:unsupported")), a.validationOptions.enabled || ee) {
        const o = (await import("./schemaValidator-Oy2yzd2p.js")).validate(e, a.portalItemLayerType);
        if (o.length > 0) {
