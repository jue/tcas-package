...
let de = class extends Be {
  ...
  loadDependencies() {
    return ni({ icon: () => import("./calcite-icon-46nwwfY1.js") });
  }
  get capabilities() {
...
async function zo(s, e, t) {
  ...
  return (await Promise.all(r.map(async (h, f) => ({ value: h, color: s.type === "opacity" ? await Vo(h, s, e) : (await import("./index-h53IWweP.js").then((c) => c.lD)).getColor(s, h), label: i ? n[f] : (l == null ? void 0 : l[f]) ?? "" })))).reverse();
}
async function Vo(s, e, t) {
  const i = new Zr(t ?? No), r = (await import("./index-h53IWweP.js").then((n) => n.lD)).getOpacity(e, s);
...
let ue = class extends Be {
  ...
  async _getRendererColors() {
    const { colorAm5: e } = await import("./chartCommon-fIBP0kSt.js"), t = /* @__PURE__ */ new Map(), i = this._getRenderer(), r = "default";
    if (!i)
      return t;
    const n = await Uo(i);
  ...
  async _renderChart(e) {
    const { root: t, mediaInfo: i } = e, { value: r, type: n } = i, { ResponsiveThemeAm5: a, DarkThemeAm5: o, AnimatedThemeAm5: l, ColorSetAm5: h, ThemeAm5: f } = await import("./chartCommon-fIBP0kSt.js"), c = f.new(t);
  ...
  async _customizeChartTooltip(e, t = "horizontal") {
    var r;
    const { colorAm5: i } = await import("./chartCommon-fIBP0kSt.js");
  ...
  async _createPieChart(e, t) {
    const { TooltipAm5: i } = await import("./chartCommon-fIBP0kSt.js"), { PieChartAm5: r, PieSeriesAm5: n } = await import("./pieChart-_brL6YWu.js"), { mediaInfo: a, root: o } = e, { title: l } = a, h = 5, f = (a == null ? void 0 : a.altText) || (a == null ? void 0 : a.title) || "", c = o.container.children.push(r.new(o, { ariaLabel: f, focusable: !0, paddingBottom: h, paddingTop: h, paddingLeft: h, paddingRight: h })), p = `{category}: {valuePercentTotal.formatNumber('0.00')}%
 ({value})`, d = i.new(o, { labelText: p }), _ = c.series.push(n.new(o, { name: l, valueField: jt, categoryField: qe, tooltip: d }));
  ...
  async _createColumnChart(e, t, i) {
    const { TooltipAm5: r, ScrollbarAm5: n } = await import("./chartCommon-fIBP0kSt.js"), { CategoryAxisAm5: a, AxisRendererXAm5: o, ValueAxisAm5: l, AxisRendererYAm5: h, ColumnSeriesAm5: f } = await import("./xyChart-UC_HPqdS.js"), { mediaInfo: c, root: p } = t, { value: d, title: _ } = c;
  ...
  async _createLineChart(e, t, i) {
    const { TooltipAm5: r, ScrollbarAm5: n } = await import("./chartCommon-fIBP0kSt.js"), { CategoryAxisAm5: a, AxisRendererXAm5: o, ValueAxisAm5: l, AxisRendererYAm5: h, LineSeriesAm5: f } = await import("./xyChart-UC_HPqdS.js"), { root: c, mediaInfo: p } = t, { value: d, title: _ } = p;
    e.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e, t) {
    const { XYChartAm5: i, XYCursorAm5: r } = await import("./xyChart-UC_HPqdS.js"), { root: n, mediaInfo: a } = e, { type: o } = a, l = (a == null ? void 0 : a.altText) || (a == null ? void 0 : a.title) || "", h = n.container.children.push(i.new(n, { ariaLabel: l, focusable: !0, panX: !0, panY: !0 }));
...
function zn() {
  return import("./arcadeUtils-KvcT7Mcm.js").then((s) => s.az);
}
function gd(s) {
...
let pe = class extends Be {
  ...
  loadDependencies() {
    return ni({ icon: () => import("./calcite-icon-46nwwfY1.js"), list: () => import("./calcite-list-ADMp3U0R.js"), "list-item": () => import("./calcite-list-item-Y7ElWh_O.js"), notice: () => import("./calcite-notice--gTKHENC.js") });
  }
  destroy() {
...
let se = Is = class extends Un(Be) {
  ...
  loadDependencies() {
    return ni({ notice: () => import("./calcite-notice--gTKHENC.js") });
  }
  destroy() {
...
async function Ld(s, e) {
  ...
  const { getColor: o, getOpacity: l, getAllSizes: h, getRotationAngle: f } = await import("./index-h53IWweP.js").then((w) => w.lD), c = [], p = [], d = [], _ = [];
...
let A = class extends Un(Be) {
  ...
  loadDependencies() {
    return ni({ action: () => import("./calcite-action-lJw05MEB.js"), flow: () => import("./calcite-flow-Z_0glsQC.js"), "flow-item": () => import("./calcite-flow-item-2s5hFBGU.js"), icon: () => import("./calcite-icon-46nwwfY1.js"), tooltip: () => import("./calcite-tooltip-Bk1MDhKS.js") });
  }
  initialize() {
