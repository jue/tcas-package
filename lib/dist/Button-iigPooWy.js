import { F as f, J as R, l as _, m as u, K as T, n as g } from "./Popup-Ycgb29QQ.js";
class p extends f {
  _beforeChanged() {
  ...
  _draw() {
    let s = this.width(), e = this.height(), t = s, i = e, l = t / Math.abs(s), c = i / Math.abs(e);
    if (_(t) && _(i)) {
      let d = Math.min(t, i) / 2, r = u(this.get("cornerRadiusTL", 8), d), n = u(this.get("cornerRadiusTR", 8), d), o = u(this.get("cornerRadiusBR", 8), d), h = u(this.get("cornerRadiusBL", 8), d), b = Math.min(Math.abs(t / 2), Math.abs(i / 2));
      r = g(r, 0, b), n = g(n, 0, b), o = g(o, 0, b), h = g(h, 0, b);
      const a = this._display;
      a.moveTo(r * l, 0), a.lineTo(t - n * l, 0), n > 0 && a.arcTo(t, 0, t, n * c, n), a.lineTo(t, i - o * c), o > 0 && a.arcTo(t, i, t - o * l, i, o), a.lineTo(h * l, i), h > 0 && a.arcTo(0, i, 0, i - h * c, h), a.lineTo(0, r * c), r > 0 && a.arcTo(0, 0, r * l, 0, r), a.closePath();
    }
  }
}
...
class m extends R {
  _afterNew() {
    this._settings.themeTags = T(this._settings.themeTags, ["button"]), super._afterNew(), this._settings.background || this.set("background", p.new(this._root, { themeTags: T(this._settings.themeTags, ["background"]) }));
  }
  _prepareChildren() {
