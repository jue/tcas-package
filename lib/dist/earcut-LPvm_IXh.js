import { au as X } from "./index-h53IWweP.js";
var D, E, F, B = { exports: {} };
B.exports, D = B, E = function() {
  function m(t, r, n) {
    n = n || 2;
    var x, i, e, u, v, f, c, l = r && r.length, s = l ? r[0] * n : t.length, a = C(t, 0, s, n, !0), y = [];
    if (!a || a.next === a.prev)
      return y;
    if (l && (a = L(t, r, a, n)), t.length > 80 * n) {
      x = e = t[0], i = u = t[1];
      for (var o = n; o < s; o += n)
        (v = t[o]) < x && (x = v), (f = t[o + 1]) < i && (i = f), v > e && (e = v), f > u && (u = f);
  ...
  function g(t, r, n, x, i, e, u) {
    if (t) {
      ...
      for (var v, f, c = t; t.prev !== t.next; )
        if (v = t.prev, f = t.next, e ? I(t, x, i, e) : G(t))
          r.push(v.i / n), r.push(t.i / n), r.push(f.i / n), w(t), t = f.next, c = f.next;
        else if ((t = f) === c) {
          u ? u === 1 ? g(t = J(h(t), r, n), r, n, x, i, e, 2) : u === 2 && K(t, r, n, x, i, e) : g(h(t), r, n, x, i, e, 1);
          break;
        }
    }
  }
  function G(t) {
    ...
    for (var i = t.next.next; i !== t.prev; ) {
      if (Z(r.x, r.y, n.x, n.y, x.x, x.y, i.x, i.y) && p(i.prev, i, i.next) >= 0)
        return !1;
      i = i.next;
    }
    return !0;
  ...
  function I(t, r, n, x) {
    ...
    for (var v = i.x < e.x ? i.x < u.x ? i.x : u.x : e.x < u.x ? e.x : u.x, f = i.y < e.y ? i.y < u.y ? i.y : u.y : e.y < u.y ? e.y : u.y, c = i.x > e.x ? i.x > u.x ? i.x : u.x : e.x > u.x ? e.x : u.x, l = i.y > e.y ? i.y > u.y ? i.y : u.y : e.y > u.y ? e.y : u.y, s = j(v, f, r, n, x), a = j(c, l, r, n, x), y = t.prevZ, o = t.nextZ; y && y.z >= s && o && o.z <= a; ) {
      if (y !== t.prev && y !== t.next && Z(i.x, i.y, e.x, e.y, u.x, u.y, y.x, y.y) && p(y.prev, y, y.next) >= 0 || (y = y.prevZ, o !== t.prev && o !== t.next && Z(i.x, i.y, e.x, e.y, u.x, u.y, o.x, o.y) && p(o.prev, o, o.next) >= 0))
        return !1;
      o = o.nextZ;
    }
    for (; y && y.z >= s; ) {
      if (y !== t.prev && y !== t.next && Z(i.x, i.y, e.x, e.y, u.x, u.y, y.x, y.y) && p(y.prev, y, y.next) >= 0)
        return !1;
      y = y.prevZ;
    }
    for (; o && o.z <= a; ) {
      if (o !== t.prev && o !== t.next && Z(i.x, i.y, e.x, e.y, u.x, u.y, o.x, o.y) && p(o.prev, o, o.next) >= 0)
        return !1;
      o = o.nextZ;
    }
    return !0;
  ...
  function J(t, r, n) {
    ...
    do {
      ...
      !M(i, e) && H(i, x, x.next, e) && d(i, e) && d(e, i) && (r.push(i.i / n), r.push(x.i / n), r.push(e.i / n), w(x), w(x.next), x = t = e), x = x.next;
    } while (x !== t);
    return h(x);
  }
  function K(t, r, n, x, i, e) {
    var u = t;
    do {
  ...
  function L(t, r, n, x) {
    ...
    for (i = 0, e = r.length; i < e; i++)
      (u = C(t, r[i] * x, i < e - 1 ? r[i + 1] * x : t.length, x, !1)) === u.next && (u.steiner = !0), v.push(T(u));
    for (v.sort(N), i = 0; i < v.length; i++)
      n = h(n = O(v[i], n), n.next);
    return n;
  }
  function N(t, r) {
    return t.x - r.x;
  ...
  function P(t, r) {
    ...
    x = n;
    do
      i >= x.x && x.x >= l && i !== x.x && Z(e < s ? i : u, e, l, s, e < s ? u : i, e, x.x, x.y) && (f = Math.abs(e - x.y) / (i - x.x), d(x, t) && (f < a || f === a && (x.x > n.x || x.x === n.x && Q(n, x))) && (n = x, a = f)), x = x.next;
    while (x !== c);
    return n;
  }
  function Q(t, r) {
  ...
  function R(t, r, n, x) {
    ...
    while (i !== t);
    i.prevZ.nextZ = null, i.prevZ = null, S(i);
  }
  function S(t) {
    ...
    do {
      for (n = t, t = null, e = null, u = 0; n; ) {
        for (u++, x = n, v = 0, r = 0; r < c && (v++, x = x.nextZ); r++)
          ;
        for (f = c; v > 0 || f > 0 && x; )
          v !== 0 && (f === 0 || !x || n.z <= x.z) ? (i = n, n = n.nextZ, v--) : (i = x, x = x.nextZ, f--), e ? e.nextZ = i : t = i, i.prevZ = e, e = i;
        n = x;
      }
      e.nextZ = null, c *= 2;
    } while (u > 1);
  ...
  function U(t, r) {
    return t.next.i !== r.i && t.prev.i !== r.i && !V(t, r) && (d(t, r) && d(r, t) && W(t, r) && (p(t.prev, t, r.prev) || p(t, r.prev, r)) || M(t, r) && p(t.prev, t, t.next) > 0 && p(r.prev, r, r.next) > 0);
  }
  function p(t, r, n) {
  ...
  function V(t, r) {
    var n = t;
    do {
      if (n.i !== t.i && n.next.i !== t.i && n.i !== r.i && n.next.i !== r.i && H(n, n.next, t, r))
        return !0;
      n = n.next;
    } while (n !== t);
    return !1;
  ...
  function A(t, r, n, x) {
    for (var i = 0, e = r, u = n - x; e < n; e += x)
      i += (t[u] - t[e]) * (t[e + 1] + t[u + 1]), u = e;
    return i;
  }
