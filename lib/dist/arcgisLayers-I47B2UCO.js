import { G as v, H as h, I as O, J as L, L as T, K as b } from "./index-O2RTvw_o.js";
import { t as d, r as P } from "./fetchService-ZQlEGV9h.js";
import { a as g } from "./lazyLayerLoader-VVlVNE9Z.js";
import "vue";
...
async function R(r) {
  ...
  const s = new (await import("./GroupLayer-NucyMaRp.js")).default({ title: e.parsedUrl.title });
  return F(s, e, a), s;
}
function S(r, l) {
