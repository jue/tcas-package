import { s as m, dB as y, dC as h, H as f, dD as w, dE as v, dF as b, c3 as x, dG as F } from "./index-h53IWweP.js";
import "vue";
...
async function C(a, n, r) {
  if (!a || !a.symbol || !n)
    return g;
  const s = a.where, l = y(a), i = s ? await import("./WhereClause-QfxSJvm_.js").then((e) => e.W) : null;
  let o;
  if (l.type === "arcade") {
