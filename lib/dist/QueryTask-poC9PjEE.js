import { aD as h, aC as j, a, b as u, eu as y, c as q, b3 as I, L as v, z as T, g as z, ev as l, b7 as m, b6 as f, H as J } from "./index-HxXrdrYt.js";
import { f as S } from "./utils-ZpixBail.js";
import { n as N, s as A } from "./executeForIds-yaL2kT5T.js";
import { S as C } from "./query-aJTyB32e.js";
import { a as $ } from "./executeQueryJSON-xprajxy2.js";
import { n as U } from "./executeQueryPBF-GnywQV_i.js";
...
let i = class extends I {
  ...
  async featureSetFromJSON(e, t, r) {
    if (!this._queryIs3DObjectFormat(e) || this.infoFor3D == null || !t.features)
      return z.fromJSON(t);
    const { meshFeatureSetFromJSON: o } = await l(import("./meshFeatureSet-zJUxNHnK.js").then((s) => s.b), r);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r }, { executeRelationshipQuery: o }] = await l(Promise.all([import("./index-HxXrdrYt.js").then((s) => s.lF), import("./executeRelationshipQuery-Sl-vAYqu.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: o }] = await l(Promise.all([import("./index-HxXrdrYt.js").then((s) => s.lF), import("./executeRelationshipQuery-Sl-vAYqu.js")]), t);
    return e = r.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), o(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r, fetchAttachments: o, processAttachmentQueryResult: s } = await l(import("./queryAttachments-eRS5wEh3.js"), t), c = S(this.url);
    return s(c, await (this.queryAttachmentsSupported ? r(c, e, t) : o(c, e, t)));
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r } = await l(import("./executeTopFeaturesQuery-UN4C62ED.js"), t);
    return r(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r } = await l(import("./executeForTopIds-cbNdhNlg.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r } = await l(import("./executeForTopExtents-a6NYntlV.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r } = await l(import("./executeForTopCount-XMcUyHRV.js"), t);
    return r(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = h.from(e);
