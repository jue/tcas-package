import { eg as q, a9 as O } from "./index-HxXrdrYt.js";
import { p as K, m as Q, y as W } from "./MeshLocalVertexSpace-0ZxfEBzd.js";
import { m as X } from "./MeshGeoreferencedRelativeVertexSpace-L53wWd_5.js";
import { n as Z, s as ee } from "./vec32-9QTi3NEX.js";
...
function te() {
  return P || (P = new Promise((e) => import("./i3s-voIytkmy.js").then((t) => t.i).then(({ default: t }) => {
...
async function we(e) {
  ...
  if (m.type === "georeferenced") {
    const { projectBuffer: l, initializeProjection: g } = await import("./index-HxXrdrYt.js").then((c) => c.lC);
    await g(i, d), f = new Float64Array(a.length), l(a, i, 0, f, d, 0, f.length / 3);
  } else {
    const { project: l } = await import("./georeference-ato9TFZB.js").then((g) => g.c);
