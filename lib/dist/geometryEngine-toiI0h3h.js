import { G as t } from "./geometryEngineBase-20MeCuAD.js";
import { hydratedAdapter as r } from "./hydrated-wwWQLead.js";
...
function j(e, n, a, s, c, u) {
  return t.offset(r, i(e), e, n, a, s, c, u);
}
function q(e, n, a, s = !1) {
  return t.buffer(r, i(e), e, n, a, s);
}
function B(e, n, a, s, c, u) {
  return t.geodesicBuffer(r, i(e), e, n, a, s, c, u);
}
function C(e, n, a = !0) {
...
function f(e) {
  var n;
  return "xmin" in e ? "center" in e ? e.center : null : "x" in e ? e : "extent" in e ? ((n = e.extent) == null ? void 0 : n.center) ?? null : null;
}
function G(e, n, a) {
  if (e == null)
    throw new o();
...
export {
  q as buffer,
  Z as changeDefaultSpatialReferenceTolerance,
  _ as clearDefaultSpatialReferenceTolerance,
  h as clip,
  R as contains,
  I as convexHull,
  x as crosses,
  ...
  y as distance,
  S as equals,
  g as extendedSpatialReferenceInfo,
  $ as flipHorizontal,
  k as flipVertical,
  F as generalize,
  W as geodesicArea,
  ...
  X as geodesicLength,
  O as intersect,
  Y as intersectLinesToPoints,
  A as intersects,
  z as isSimple,
  C as nearestCoordinate,
  E as nearestVertex,
