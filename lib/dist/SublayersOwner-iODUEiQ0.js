import { e as a, d as n, aE as g, M as Q, bI as Y, dX as Z, m as ee, a as N, C as G, R as re, bc as te, s as K, aw as ie, bz as se, f6 as ae, y as E, az as y, aT as le, f7 as oe, bk as ne, f8 as $, e5 as ye, j as R, I as pe, bC as _, dQ as ue, dI as U, S as D, r as B, bY as de, ef as ce, bW as M, dU as fe, bD as w, B as he, dY as be, dZ as ge, f9 as J, fa as q, c7 as me, e0 as Se, bU as F, W as ve, e7 as Ie, fb as we } from "./index-Ek1MTSEY.js";
import { r as Ee } from "./Version-sFmbM26K.js";
import { l as Le } from "./floorFilterUtils-HsstcPZ9.js";
import { o as xe } from "./sublayerUtils-D2vrXRHA.js";
const Ae = (e) => {
...
let l = P = class extends ie(se(ae(ve))) {
  ...
  async createFeatureLayer() {
    ...
    if (this.hasOwnProperty("sublayers"))
      return null;
    const t = (e = this.layer) == null ? void 0 : e.parsedUrl, i = new (await import("./index-Ek1MTSEY.js").then((s) => s.kH)).default({ url: t.path });
  ...
  async queryFeatures(e = this.createQuery(), r) {
    ...
    const [{ executeQuery: p }, { default: d }] = await Promise.all([import("./index-Ek1MTSEY.js").then((c) => c.kE), import("./index-Ek1MTSEY.js").then((c) => c.kF)]), m = await p(this.url, U.from(e), (t = (i = this.layer) == null ? void 0 : i.spatialReference) != null ? t : null, { ...r, query: { ...(s = this.layer) == null ? void 0 : s.customParameters, token: (o = this.layer) == null ? void 0 : o.apiKey } }), b = d.fromJSON(m.data);
