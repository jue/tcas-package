import { z as Et, eg as bt } from "./index-HxXrdrYt.js";
import { e as I, n as D } from "./enums-QU6RH5ju.js";
import { $ as pt } from "./definitions-5wPyT42Z.js";
const Mt = 128e3;
let dt = null, gt = null;
async function St() {
  return dt || (dt = Rt()), dt;
...
async function Rt() {
  gt = await (Et("geoscene-csp-restrictions") ? await import("./libtess-asm-lQNiEayf.js").then((i) => i.l) : await import("./libtess-O_GX5NPz.js").then((i) => i.l)).load({ locateFile: (i) => bt(`geoscene/core/libs/libtess/${i}`) });
}
function $t(x, i) {
