import { e as u, d, dL as mt, bD as dt, aE as yt, a as ee, aD as xe, gu as Be, iE as wt, fa as Fe, db as et, r as f, s as W, c7 as z, S as C, iF as xt, iG as _, f$ as M, eu as Ie, ab as L, bg as vt, iH as $t, iI as bt, eP as At, bc as Mt, l as se, y as Te, hc as Pe, g6 as tt, g5 as Se, gd as nt, gf as he, gh as Ft, hf as rt, hk as fe, iJ as Tt, g4 as Dt, iw as ot, iK as st, aw as Rt, W as Ct, gC as Et, cE as Lt, f as Ot, M as De, ac as It, dd as $e, x as Pt, b as St } from "./index-j1oaLRcp.js";
import { r as ve, M as jt, x as Nt, a as je, j as Ne, b as _e, O as ze, h as Ue, L as We, k as _t, c as ie, q as Re, d as zt, l as Ce, e as ue, f as ge } from "./georeference-Hy_-aUKc.js";
import { x as Ut } from "./earcut-80XuLCNX.js";
import { n as Wt } from "./deduplicate-1-XIbeYo.js";
import { d as it, b as ke } from "./vec33-KIqI1xKc.js";
var J;
...
async function rn(e, t, n) {
  const { loadGLTFMesh: r } = await Ie(import("./loadGLTFMesh-g2T_TuKy.js"), n), o = await at(t, n), s = r(new L({ x: 0, y: 0, z: 0, spatialReference: e.spatialReference }), o.url, { resolveFile: on(o), useTransform: !0, signal: f(n) ? n.signal : null });
...
async function an(e, t) {
  const { default: n } = await Ie(import("./index-j1oaLRcp.js").then((o) => o.kD), t), r = typeof e.multipart[0] == "string" ? await Promise.all(e.multipart.map(async (o) => (await n(o, { responseType: "array-buffer" })).data)) : e.multipart;
...
let F = R = class extends Rt(Ct.LoadableMixin(Et(Lt))) {
  ...
  async toBinaryGLTF(e) {
    const { toBinaryGLTF: t } = await import("./gltfexport-Oryet1AF.js");
    return t(this, e);
  }
  ...
  static async createFromGLTF(e, t, n) {
    ...
    const { loadGLTFMesh: r } = await Ie(import("./loadGLTFMesh-g2T_TuKy.js"), n);
