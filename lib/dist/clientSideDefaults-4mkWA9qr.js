import { bd as o, be as u, bf as n, z as a, aT as i } from "./index-h53IWweP.js";
import { t as c } from "./QueryEngineCapabilities-gkC_bzZo.js";
function h(t) {
...
let y = 1;
function A(t, s) {
  if (a("geoscene-csp-restrictions"))
    return () => ({ [s]: null, ...t });
  try {
    let r = `this.${s} = null;`;
    for (const e in t)
