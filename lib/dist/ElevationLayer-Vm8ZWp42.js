import { dK as _, s as g, fP as f, gD as w, b5 as c, cN as b, cm as V, cn as T, cp as S, gE as D, H as $, cq as L, ae as u, d5 as x, a as o, b as l, bl as y, gF as k, cu as N, c as I, ax as M } from "./index-h53IWweP.js";
import { p as j } from "./ArcGISCachedService-rIKxJO9A.js";
import "vue";
...
let r = class extends j(b(V(T(S(M))))) {
  ...
  async queryElevation(s, e) {
    const { ElevationQuery: t } = await import("./ElevationQuery-jpGfZAeW.js");
