import { G as v, H as h, I as O, J as L, L as T, K as b } from "./index-HxXrdrYt.js";
import { t as d, r as P } from "./fetchService-CoYeNX8r.js";
import { a as g } from "./lazyLayerLoader-_O0PGMG3.js";
import "vue";
...
async function R(r) {
  ...
  const s = new (await import("./GroupLayer-9I2eLl0R.js")).default({ title: e.parsedUrl.title });
  return F(s, e, a), s;
}
function S(r, l) {
