import { da as v, db as x, dc as y, dd as n, de as f, df as C } from "./index-B7TsCcH6.js";
import { g as k } from "./guid-mHDePIZO.js";
import { d as z, c as w, a as I, u as E } from "./loader-uhOBkpV9.js";
import { s as L, a as T, c as S } from "./loadable-Dx1OeX96.js";
import { u as M, c as O, a as $, s as F, d as H, b as R, g as W } from "./component-OY5O9yj9.js";
import { c as j } from "./observers-9seiNSXN.js";
import { d as D } from "./icon-bnQnkqci.js";
/*!
...
const o = {
  ...
  connectedCallback() {
    var t;
    w(this), O(this), $(this), (t = this.mutationObserver) == null || t.observe(this.el, { childList: !0, subtree: !0 });
  }
  ...
  disconnectedCallback() {
    var t;
    I(this), H(this), R(this), (t = this.mutationObserver) == null || t.disconnect();
  }
  componentDidRender() {
    E(this);
  }
  ...
  async setFocus() {
    var t;
    await S(this), (t = this.buttonEl) == null || t.focus();
  }
  // --------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  renderTextContainer() {
    const { text: t, textEnabled: e } = this, i = {
      [o.textContainer]: !0,
      [o.textContainerVisible]: e
    };
    return t ? n("div", { class: i, key: "text-container" }, t) : null;
  }
  renderIndicatorText() {
    const { indicator: t, messages: e, indicatorId: i, buttonId: a } = this;
    return n("div", { "aria-labelledby": a, "aria-live": "polite", class: o.indicatorText, id: i, role: "region" }, t ? e.indicator : null);
  }
  renderIconContainer() {
    var r;
    const { loading: t, icon: e, scale: i, el: a, iconFlipRtl: l, indicator: d } = this, u = i === "l" ? "l" : "m", b = t ? n("calcite-loader", { inline: !0, label: this.messages.loading, scale: u }) : null, c = e ? n("calcite-icon", { class: { [o.indicatorWithIcon]: d }, flipRtl: l, icon: e, scale: W(this.scale) }) : null, s = b || c, h = s || ((r = a.children) == null ? void 0 : r.length), p = n("div", { class: {
      [o.slotContainer]: !0,
      [o.slotContainerHidden]: t
    } }, n("slot", null));
    return h ? n("div", { "aria-hidden": "true", class: o.iconContainer, key: "icon-container" }, s, p) : null;
  }
  render() {
    const { active: t, compact: e, disabled: i, icon: a, loading: l, textEnabled: d, label: u, text: b, indicator: c, indicatorId: s, buttonId: h, messages: p } = this, r = `${u || b}${c ? ` (${p.indicator})` : ""}`, m = {
      [o.button]: !0,
      [o.buttonTextVisible]: d,
      [o.buttonCompact]: e
    };
    return n(C, null, n("button", {
      "aria-busy": f(l),
      "aria-controls": c ? s : null,
      "aria-disabled": f(i),
      "aria-label": r,
      "aria-pressed": f(t),
      class: m,
      ...
      ref: (g) => this.buttonEl = g
    }, this.renderIconContainer(), this.renderTextContainer(), !a && c && n("div", { class: o.indicatorWithoutIcon, key: "indicator-no-icon" })), n("slot", { name: V.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText());
  }
...
function U() {
  if (typeof customElements > "u")
    return;
  ["calcite-action", "calcite-icon", "calcite-loader"].forEach((e) => {
    switch (e) {
      case "calcite-action":
