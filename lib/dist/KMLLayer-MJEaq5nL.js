import { eB as O, ci as _, w as v, l as p, dN as u, fa as g, aC as d, fb as $, V as b, a as s, b as i, fc as F, bl as h, c as m, e4 as j, ck as M, cl as C, co as I, cm as N, cn as K, cp as P, x as R, a9 as S, J as T, cq as J, cU as z, cu as A, ax as V } from "./index-B7TsCcH6.js";
import { j as W, S as w, g as x, d as k } from "./kmlUtils-AR0O75zu.js";
import "vue";
var y;
let a = y = class extends O.EventedMixin(_(j)) {
  constructor(...e) {
    ...
    }, u), p(() => this.sublayers, (t, r) => {
      if (r)
        for (const l of r)
          l.layer = l.parent = null;
      if (t)
        for (const l of t)
          l.parent = this, l.layer = this.layer;
    }, u), p(() => this.layer, (t) => {
      if (this.sublayers)
  ...
  initialize() {
    g(() => this.networkLink).then(() => g(() => this.visible === !0)).then(() => this.load());
  }
  load(e) {
    var l;
    if (!this.networkLink || this.networkLink.viewFormat)
      return;
    const t = e != null ? e.signal : null, r = this._fetchService(((l = this._get("networkLink")) == null ? void 0 : l.href) ?? "", t).then((n) => {
      var f;
      const L = W(n.sublayers);
      this.fullExtent = d.fromJSON(L), this.sourceJSON = n;
      const c = $(b.ofType(y), w(y, n));
      this.sublayers ? this.sublayers.addMany(c) : this.sublayers = c, (f = this.layer) == null || f.emit("sublayer-update"), this.layer && this.layer.notifyChange("visibleSublayers");
    });
  ...
  _fetchService(e, t) {
    return x(e, this.layer.outSpatialReference, this.layer.refreshInterval, t).then((r) => k(r.data));
  }
};
s([i()], a.prototype, "description", void 0), s([i({ type: d })], a.prototype, "fullExtent", void 0), s([i()], a.prototype, "id", void 0), s([i({ readOnly: !0, value: null })], a.prototype, "networkLink", void 0), s([i({ json: { write: { allowNull: !0 } } })], a.prototype, "parent", void 0), s([i({ type: b.ofType(y), json: { write: { allowNull: !0 } } })], a.prototype, "sublayers", void 0), s([i({ value: null, json: { read: { source: "name", reader: (e) => F(e) } } })], a.prototype, "title", void 0), s([i({ value: !0 })], a.prototype, "visible", null), s([h("visible", ["visibility"])], a.prototype, "readVisible", null), s([i()], a.prototype, "sourceJSON", void 0), s([i()], a.prototype, "layer", void 0), a = y = s([m("geoscene.layers.support.KMLSublayer")], a);
const E = a, H = ["kml", "xml"];
let o = class extends M(C(I(N(K(P(V)))))) {
  constructor(...e) {
  ...
  initialize() {
    this.addHandles([p(() => this.sublayers, (e, t) => {
      t && t.forEach((r) => {
  ...
  get title() {
    ...
    return e && this.originOf("title") !== "defaults" ? e : this.url ? T(this.url, H) || "KML" : e || "";
  }
  set title(e) {
    this._set("title", e);
  }
  ...
  load(e) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["KML"], supportsData: !1 }, e).catch(J).then(() => this._fetchService(t))), Promise.resolve(this);
  }
  destroy() {
    super.destroy(), this.allSublayers.destroy();
  }
  async _fetchService(e) {
    const t = await Promise.resolve().then(() => this.resourceInfo ? { ssl: !1, data: this.resourceInfo } : x(this.url ?? "", this.outSpatialReference, this.refreshInterval, e)), r = k(t.data);
