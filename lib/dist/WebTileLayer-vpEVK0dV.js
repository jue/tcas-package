...
let s = f = class extends P($(I(M(U(W(q)))))) {
    ...
    const t = this.loadFromPortal({ supportedTypes: ["WMTS"] }, e).then(() => {
      ...
      if (this.urlTemplate)
        if (this.spatialReference.equals(this.tileInfo.spatialReference)) {
          const n = new m(this.urlTemplate);
          !(this.subDomains && this.subDomains.length > 0) && ((a = n.authority) != null && a.includes("{subDomain}")) && (i = "is missing 'subDomains' property");
        } else
  ...
  readSpatialReference(e, t) {
    return e || t.fullExtent && t.fullExtent.spatialReference && h.fromJSON(t.fullExtent.spatialReference);
  }
  get tileServers() {
    if (!this.urlTemplate)
      return null;
    const e = [], { urlTemplate: t, subDomains: i } = this, a = new m(t), n = a.scheme ? a.scheme + "://" : "//", c = n + a.authority + "/", p = a.authority;
    if (p != null && p.includes("{subDomain}")) {
      if (i && i.length > 0 && p.split(".").length > 1)
        for (const u of i)
          e.push(n + p.replaceAll(/\{subDomain\}/gi, u) + "/");
    } else
      e.push(c);
    return e.map((u) => (u.charAt(u.length - 1) !== "/" && (u += "/"), u));
  }
  get urlPath() {
    if (!this.urlTemplate)
      return null;
    const e = this.urlTemplate, t = new m(e), i = (t.scheme ? t.scheme + "://" : "//") + t.authority + "/";
  ...
  writeUrlTemplate(e, t) {
    e && D(e) && (e = "https:" + e), e && (e = e.replaceAll(/\{z\}/gi, "{level}").replaceAll(/\{x\}/gi, "{col}").replaceAll(/\{y\}/gi, "{row}"), e = O(e)), t.templateUrl = e;
  }
  fetchTile(e, t, i, a = {}) {
    const { signal: n } = a, c = this.getTileUrl(e, t, i), p = { responseType: "image", signal: n, query: { ...this.refreshParameters } };
    return w(c, p).then((u) => u.data);
  }
  async fetchImageBitmapTile(e, t, i, a = {}) {
    const { signal: n } = a;
    if (this.fetchTile !== f.prototype.fetchTile) {
      const x = await this.fetchTile(e, t, i, a);
      return b(x, e, t, i, n);
    }
    const c = this.getTileUrl(e, t, i), p = { responseType: "blob", signal: n, query: { ...this.refreshParameters } }, { data: u } = await w(c, p);
    return b(u, e, t, i, n);
  }
  getTileUrl(e, t, i) {
    const { levelValues: a, tileServers: n, urlPath: c } = this;
    if (!a || !n || !c)
      return "";
    const p = a[e];
    return n[t % n.length] + z(c, { level: p, z: p, col: i, x: i, row: t, y: t });
  }
};
l([o({ type: String, value: "", json: { write: !0 } })], s.prototype, "copyright", void 0), l([o({ type: j, json: { write: !0 }, nonNullable: !0 })], s.prototype, "fullExtent", void 0), l([o({ readOnly: !0, json: { read: !1, write: !1 } })], s.prototype, "legendEnabled", void 0), l([o({ type: ["show", "hide"] })], s.prototype, "listMode", void 0), l([o({ json: { read: !0, write: !0 } })], s.prototype, "blendMode", void 0), l([o()], s.prototype, "levelValues", null), l([o({ type: Boolean, json: { read: !1, write: { enabled: !0, overridePolicy: () => ({ enabled: !1 }) } } })], s.prototype, "isReference", void 0), l([o({ type: ["WebTiledLayer"], value: "WebTiledLayer" })], s.prototype, "operationalLayerType", void 0), l([o({ readOnly: !0, json: { read: !1, write: !1 } })], s.prototype, "popupEnabled", void 0), l([o({ type: h })], s.prototype, "spatialReference", void 0), l([g("spatialReference", ["spatialReference", "fullExtent.spatialReference"])], s.prototype, "readSpatialReference", null), l([o({ type: [String], json: { write: !0 } })], s.prototype, "subDomains", void 0), l([o({ type: S, json: { write: !0 } })], s.prototype, "tileInfo", void 0), l([o({ readOnly: !0 })], s.prototype, "tileServers", null), l([o({ json: { read: !1 } })], s.prototype, "type", void 0), l([o()], s.prototype, "urlPath", null), l([o({ type: String, json: { origins: { "portal-item": { read: { source: "url" } } } } })], s.prototype, "urlTemplate", void 0), l([g("urlTemplate", ["urlTemplate", "templateUrl"])], s.prototype, "readUrlTemplate", null), l([A("urlTemplate", { templateUrl: { type: String } })], s.prototype, "writeUrlTemplate", null), l([o({ type: y, json: { write: !0 } })], s.prototype, "wmtsInfo", void 0), s = f = l([T("geoscene.layers.WebTileLayer")], s);
const V = s, B = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: V
