import { ci as P, fD as y, a as t, b as n, cV as m, gC as w, hx as q, c as h, hy as R, az as v, d8 as z, hz as D, hA as S, V as $, v as E, l as N, f9 as j, u as C, hB as T, aC as x, cm as k, cp as A, cU as L, ax as _ } from "./index-O2RTvw_o.js";
import { c as H } from "./Analysis-dzKNrl7R.js";
import "vue";
let r = class extends P(R) {
  constructor(e) {
...
t([n({ type: ["simple"], readOnly: !0, json: { write: { isRequired: !0 } } })], r.prototype, "type", void 0), t([n({ type: y, nonNullable: !0, json: { type: [m], write: { isRequired: !0 } } })], r.prototype, "color", void 0), t([n({ type: Number, cast: w, nonNullable: !0, range: { min: q(1) }, json: { write: { isRequired: !0 } } })], r.prototype, "lineSize", void 0), t([n({ type: Number, cast: w, nonNullable: !0, json: { write: { isRequired: !0 } } })], r.prototype, "fontSize", void 0), t([n({ type: y, nonNullable: !0, json: { type: [m], write: { isRequired: !0 } } })], r.prototype, "textColor", void 0), t([n({ type: y, nonNullable: !0, json: { type: [m], write: { isRequired: !0 } } })], r.prototype, "textBackgroundColor", void 0), r = t([h("geoscene.analysis.DimensionSimpleStyle")], r);
const f = r;
var d;
(function(e) {
...
let a = class extends H {
  ...
  set dimensions(e) {
    this._set("dimensions", C(e, this.dimensions, g));
  }
  get spatialReference() {
    for (const e of this.dimensions) {
      if (e.startPoint != null)
        return e.startPoint.spatialReference;
      if (e.endPoint != null)
        return e.endPoint.spatialReference;
    }
    return null;
  }
  ...
  _computeExtent() {
    ...
    const i = [];
    for (const o of this.dimensions)
      o.startPoint != null && i.push(o.startPoint), o.endPoint != null && i.push(o.endPoint);
    const p = T(i, e);
    if (p.pending != null)
      return { pending: p.pending, extent: null };
    let c = null;
    return p.geometries != null && (c = p.geometries.reduce((o, u) => o == null ? u != null ? x.fromPoint(u) : null : u != null ? o.union(x.fromPoint(u)) : o, null)), { pending: null, extent: c };
  }
  clear() {
    this.dimensions.removeAll();
  }
};
t([n({ type: ["dimension"] })], a.prototype, "type", void 0), t([n({ cast: E, type: g, nonNullable: !0 })], a.prototype, "dimensions", null), t([n({ readOnly: !0 })], a.prototype, "spatialReference", null), t([n({ types: { key: "type", base: null, typeMap: { simple: f } }, nonNullable: !0 })], a.prototype, "style", void 0), t([n({ value: null, readOnly: !0 })], a.prototype, "extent", void 0), t([n({ readOnly: !0 })], a.prototype, "requiredPropertiesForEditing", null), a = t([h("geoscene.analysis.DimensionAnalysis")], a);
const b = a;
let s = class extends k(A(_)) {
  constructor(e) {
    if (super(e), this.type = "dimension", this.operationalLayerType = "ArcGISDimensionLayer", this.source = new b(), this.opacity = 1, e) {
  ...
  releaseAnalysis(e) {
    this.source === e && (this.source = new b());
  }
  get analysis() {
    return this.source;
  }
