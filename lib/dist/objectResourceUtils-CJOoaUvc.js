...
import { t as yo } from "./requestImageUtils-kTD89hj5.js";
import { t as ya, u as ct, N as sr, a as Oe, i as X, n as Me, e as Tt } from "./basicInterfaces-qgybO4Nz.js";
import { y as Br, t as Ca } from "./Indices-JU1hbf1W.js";
import { s as H, H as wa } from "./InterleavedLayout-q9kLyzue.js";
import { s as Co, _ as wo } from "./sphere-LhraSVmh.js";
import { v as Oa } from "./lineSegment-9sF-MMaA.js";
...
import { T as ut, E as Ea, e as Ra, b as $a } from "./Texture-RB7_nCpt.js";
...
import { S as Va } from "./quat-urNuMsK8.js";
...
import { n as be } from "./symbolColorUtils-hFHVyUEz.js";
...
function an() {
  if (Qt == null) {
    ...
    Qt = import("./basis_transcoder-WnhyTq8o.js").then((e) => e.b).then(({ default: e }) => e({ locateFile: t }).then((r) => (r.initializeBasis(), delete r.then, r)));
  }
  return Qt;
}
let Qt;
...
Zs.shader = new Gt(Qs, () => import("./SSAOBlur.glsl-I3MjYpAo.js"));
function Js(t) {
...
rl.shader = new Gt(tl, () => import("./SSAO.glsl-F7NyhUCk.js"));
const ol = 2;
function Or(t, e) {
  const r = t.fragment;
...
_t.shader = new Gt(gl, () => import("./DefaultMaterial.glsl-D6LbMgAd.js"));
class ke extends ai {
}
...
jt.shader = new Gt(bl, () => import("./RealisticTree.glsl-EP-iXti_.js"));
