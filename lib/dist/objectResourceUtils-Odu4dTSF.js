...
import { t as yo } from "./requestImageUtils-yGZ38UhV.js";
import { t as ya, u as ct, N as sr, a as Oe, i as X, n as Me, e as Tt } from "./basicInterfaces-qgybO4Nz.js";
import { y as Br, t as Ca } from "./Indices-KRi0uqNt.js";
import { s as H, H as wa } from "./InterleavedLayout-bbXod9fB.js";
import { s as Co, _ as wo } from "./sphere-MqKkgQLJ.js";
import { v as Oa } from "./lineSegment-5vrLPGzx.js";
...
import { T as ut, E as Ea, e as Ra, b as $a } from "./Texture-9jggcs3t.js";
...
import { S as Va } from "./quat-e5sgx9ql.js";
...
import { n as be } from "./symbolColorUtils-XC564eH2.js";
...
function an() {
  if (Qt == null) {
    ...
    Qt = import("./basis_transcoder-7NV2nP0T.js").then((e) => e.b).then(({ default: e }) => e({ locateFile: t }).then((r) => (r.initializeBasis(), delete r.then, r)));
  }
  return Qt;
}
let Qt;
...
Zs.shader = new Gt(Qs, () => import("./SSAOBlur.glsl-gvVRl94F.js"));
function Js(t) {
...
rl.shader = new Gt(tl, () => import("./SSAO.glsl-IlCdUcz1.js"));
const ol = 2;
function Or(t, e) {
  const r = t.fragment;
...
_t.shader = new Gt(gl, () => import("./DefaultMaterial.glsl-mezrlwSa.js"));
class ke extends ai {
}
...
jt.shader = new Gt(bl, () => import("./RealisticTree.glsl-GIw8iz8w.js"));
