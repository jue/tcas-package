...
const u = {
  ...
  blank: "blank",
  close: "x"
}, a = "calcite-list", i = "calcite-list-item-group", r = "calcite-list-item";
function p(n) {
  const e = n.assignedElements({ flatten: !0 }), o = e.filter((t) => t == null ? void 0 : t.matches(i)).map((t) => Array.from(t.querySelectorAll(r))).reduce((t, c) => [...t, ...c], []), s = e.filter((t) => t == null ? void 0 : t.matches(r));
  return [...e.filter((t) => t == null ? void 0 : t.matches(a)).map((t) => Array.from(t.querySelectorAll(r))).reduce((t, c) => [...t, ...c], []), ...o, ...s];
}
function h(n) {
  n.forEach((e) => {
