import { z as o, B as n } from "./index-B7TsCcH6.js";
import { a as l } from "./AttributeStoreView-gMBKUgth.js";
const i = o("geoscene-2d-log-allocations");
class a {
  constructor(t, e) {
  ...
  slice() {
    ...
    return t.set(this._array), new a(t, this._pool);
  }
}
class s {
  constructor() {
    this._data = new ArrayBuffer(s.BYTE_LENGTH), this._freeList = new l({ start: 0, end: this._data.byteLength });
  }
  ...
  allocate(t) {
    ...
    return e == null ? null : new Uint32Array(this._data, e, t / Uint32Array.BYTES_PER_ELEMENT);
  }
  free(t) {
...
class y {
  ...
  get _bytesTotal() {
    return this._pages.length * s.BYTE_LENGTH;
  }
  acquire(t) {
    if (this._bytesAllocated += t, i && console.log(`Allocating ${t}, (${this._bytesAllocated} / ${this._bytesTotal})`), t > s.BYTE_LENGTH)
      return new Uint32Array(t / Uint32Array.BYTES_PER_ELEMENT);
    for (const e of this._pages) {
      const r = e.allocate(t);
      if (r != null)
        return r;
    }
    return n(this._addPage().allocate(t), "Expected to allocate page");
  }
  release(t) {
