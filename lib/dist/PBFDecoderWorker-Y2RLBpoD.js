import { ew as c, a9 as d, cW as p, fQ as f, fR as m } from "./index-O2RTvw_o.js";
import { I as y, s as _ } from "./featureConversionUtils-9-9v0Fhl.js";
import { t as g } from "./pbfQueryUtils-yEqcNzVb.js";
import "vue";
...
let P = class {
  constructor(t, e, r) {
    this.uid = t, this.geometry = e, this.attributes = r, this.visible = !0, this.objectId = null, this.centroid = null;
  }
};
class C {
  constructor() {
...
function l(i, t, e, r) {
  switch (e) {
    case 0:
      return h(i, t + r, 0);
    case 1:
      return i.originPosition === "lowerLeft" ? h(i, t + r, 1) : M(i, t + r, 1);
  }
}
function u(i, t, e, r) {
  return e === 2 ? h(i, t, 2) : l(i, t, e, r);
}
function G(i, t, e, r) {
  return e === 2 ? h(i, t, 3) : l(i, t, e, r);
}
function v(i, t, e, r) {
  return e === 3 ? h(i, t, 3) : u(i, t, e, r);
}
function h({ translate: i, scale: t }, e, r) {
  return i[r] + e * t[r];
}
function M({ translate: i, scale: t }, e, r) {
  return i[r] - e * t[r];
}
class R {
  constructor(t) {
  ...
  finishFeatureResult(t) {
    ...
    }, this._coordinateBuffer = null, this._lengths.length = 0, !t.hasZ)
      return;
    const e = c(t.geometryType, this._options.sourceSpatialReference, t.spatialReference);
    if (e != null)
  ...
  addFeature(t, e) {
    ...
    if (r > 0)
      for (const s in e.attributes) {
        ...
        typeof o == "string" && o.length > r && (e.attributes[s] = "");
      }
    t.features.push(e);
  }
  addQueryGeometry(t, e) {
    const { queryGeometry: r, queryGeometryType: s } = e, o = y(r.clone(), r, !1, !1, this._transform), a = _(o, s, !1, !1);
    let n = null;
    switch (s) {
    ...
    a.type = n, t.queryGeometryType = s, t.queryGeometry = a;
  }
  prepareFeatures(t) {
    switch (this._transform = t.transform ?? null, this._options.applyTransform && t.transform && (this._applyTransform = this._deriveApplyTransform(t)), this._vertexDimension = 2, t.hasZ && this._vertexDimension++, t.hasM && this._vertexDimension++, t.geometryType) {
      case "point":
        this.addCoordinate = (e, r, s) => this.addCoordinatePoint(e, r, s), this.createGeometry = (e) => this.createPointGeometry(e);
        break;
      case "polygon":
        this.addCoordinate = (e, r, s) => this._addCoordinatePolygon(e, r, s), this.createGeometry = (e) => this._createPolygonGeometry(e);
        break;
      case "polyline":
        this.addCoordinate = (e, r, s) => this._addCoordinatePolyline(e, r, s), this.createGeometry = (e) => this._createPolylineGeometry(e);
        break;
      case "multipoint":
        this.addCoordinate = (e, r, s) => this._addCoordinateMultipoint(e, r, s), this.createGeometry = (e) => this._createMultipointGeometry(e);
        break;
      case "mesh":
      case "extent":
        break;
  ...
  createFeature() {
    return this._lengths.length = 0, this._currentLengthIndex = 0, this._previousCoordinate[0] = 0, this._previousCoordinate[1] = 0, new P(m(), null, new this._attributesConstructor());
  }
  allocateCoordinates() {
    const t = this._lengths.reduce((e, r) => e + r, 0);
  ...
  addCoordinatePoint(t, e, r) {
    const s = this._transform ? this._applyTransform(this._transform, e, r, 0) : e;
    if (s != null)
      switch (r) {
        case 0:
          t.x = s;
  ...
  _transformPathLikeValue(t, e) {
    let r = 0;
    return e <= 1 && (r = this._previousCoordinate[e], this._previousCoordinate[e] += t), this._transform ? this._applyTransform(this._transform, t, e, r) : t;
  }
  ...
  _dehydratedAddPointsCoordinate(t, e, r) {
    r === 0 && this._toAddInCurrentPath-- == 0 && (t.push([]), this._toAddInCurrentPath = this._lengths[++this._currentLengthIndex] - 1, this._previousCoordinate[0] = 0, this._previousCoordinate[1] = 0);
    const s = this._transformPathLikeValue(e, r), o = t[t.length - 1], a = this._coordinateBuffer;
    if (a) {
      if (r === 0) {
  ...
  _deriveApplyTransform(t) {
    ...
    return e && r ? v : e ? u : r ? G : l;
  }
}
class T {
  _parseFeatureQuery(t) {
    var s;
    const e = g(t.buffer, new R(t.options)), r = { ...e, spatialReference: (s = e.spatialReference) == null ? void 0 : s.toJSON(), fields: e.fields ? e.fields.map((o) => o.toJSON()) : void 0 };
