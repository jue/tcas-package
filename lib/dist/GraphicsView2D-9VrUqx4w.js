import { jW as me, $ as U, _ as D, aA as Ve, c1 as ue, a4 as ae, hN as je, jX as ee, gH as ke, iB as Ke, jY as He, a6 as Ee, dZ as k, z as qe, cj as Ze, b0 as Ne, dY as Ye, l as Xe, b5 as v, R as Qe, jZ as We, j_ as Je, d as K, a9 as et, cq as ye, ad as tt, a5 as ge, a3 as xe, j$ as st, a1 as _e, a2 as te, k0 as it, k1 as rt, k2 as nt, a as C, b as T, c as ot, b3 as at } from "./index-h53IWweP.js";
import { s as ve, t as lt, e as dt, i as ht } from "./ExpandedCIM-3LZTL41U.js";
import { a as ct } from "./normalizeUtilsSync-cNupCt2o.js";
import { f as ut, g as ft } from "./projectionSupport-p_kmYZqX.js";
import { X as pt } from "./definitions-Ikx6Iti_.js";
import { x as fe, F as N, j as le, H as mt, Y as yt, P as Q, R as gt, t as xt, S as Me } from "./color-4NJ3Arr4.js";
import { u as _t, c as be } from "./VertexArrayObject-xRQjh19m.js";
import { F as vt } from "./enums-Vyj7xNgv.js";
import { m as bt, r as Dt, T as De, _ as Ct, o as wt } from "./AttributeStoreView-XrRsw0gL.js";
import { U as Tt } from "./GeometryUtils-qBcr22nw.js";
import { e as Y, o as Ft, x as Bt, a as Rt, r as St, E as It } from "./Matcher-EB2LXM-b.js";
import { h as Mt, I as Lt, r as zt, B as At } from "./ComputedAttributeStorage-X4eusieF.js";
import { o as $t, C as Gt, d as Ot, h as Pt, $ as Ut } from "./featureConversionUtils-Uyb-YOAh.js";
import { v as Vt } from "./normalizeUtils-zXVQRAEh.js";
import { L as jt, d as $ } from "./quantizationUtils-r2uAqrNR.js";
import { t as Le } from "./OptimizedGeometry-VApaomRE.js";
const y = -1;
let Ce = class {
  constructor() {
    this._dirties = [{ vertexFrom: y, vertexCount: y, indexFrom: y, indexCount: y, allDirty: !1 }, { vertexFrom: y, vertexCount: y, indexFrom: y, indexCount: y, allDirty: !1 }, { vertexFrom: y, vertexCount: y, indexFrom: y, indexCount: y, allDirty: !1 }, { vertexFrom: y, vertexCount: y, indexFrom: y, indexCount: y, allDirty: !1 }, { vertexFrom: y, vertexCount: y, indexFrom: y, indexCount: y, allDirty: !1 }];
  }
  hasDirty() {
    return this._dirties.some((e) => e.indexCount !== y || e.allDirty);
  }
  markAllClean() {
    for (const e of this._dirties)
      e.indexFrom = y, e.indexCount = y, e.vertexFrom = y, e.vertexCount = y, e.allDirty = !1;
  }
  markAllDirty() {
    for (const e of this._dirties)
      e.allDirty = !0;
  ...
  forEach(e) {
    for (let t = 0; t < this._dirties.length; ++t) {
      ...
      let l, d = !1;
      (a || n !== y && r > 0) && (h.geometry = { count: r, from: n, allDirty: a }, d = !0), (a || i !== y && s > 0) && (l = { count: s, from: i, allDirty: a }, d = !0), d && e({ indices: l, vertices: h }, t);
    }
  }
  ...
  markDirtyVertices(e, t, s, i) {
    ...
    if (!r.allDirty)
      if (r.vertexCount !== y) {
        const h = Math.min(r.vertexFrom, n), l = Math.max(r.vertexFrom + r.vertexCount, n + a) - h;
        r.vertexFrom = h, r.vertexCount = l;
      } else
  ...
  constructor(e, t) {
    this._allocated = 0, this._size = e, this._freeHead = e > 0 ? { from: 0, count: e, prev: null, next: null } : null, this._bookKeeper = t || new kt(this), this._freeHead && this._bookKeeper.rangeCreated(this._freeHead);
  }
  allocate(e) {
    ...
    if (t.from += e, t.count -= e, this._bookKeeper.rangeResized(t, s, i), this._allocated += e, t.count === 0) {
      ...
      L._removeRange(t), this._freeHead = r;
    }
    return s;
  }
  free(e, t) {
    const [s, i] = this._bookKeeper.findAdjacentRanges(e, t), r = { from: e, count: t, prev: s ?? null, next: i ?? null };
    if (s != null && (s.next = r), i != null && (i.prev = r), this._bookKeeper.rangeCreated(r), this._allocated -= t, i != null && r.from + r.count === i.from) {
      ...
      L._fuse(r, i), L._removeRange(i), this._bookKeeper.rangeResized(r, n, a), this._bookKeeper.rangeResized(i, void 0, 0);
    }
    if (s != null && s.from + s.count === r.from) {
      const n = s.from, a = s.count;
      L._fuse(s, r), L._removeRange(r), this._bookKeeper.rangeResized(s, n, a), this._bookKeeper.rangeResized(r, void 0, 0);
    }
...
const P = ["FILL", "LINE", "MARKER", "TEXT", "LABEL"];
function Kt(o) {
...
let Te = class ze {
  constructor(e, t, s, i) {
    ...
    for (const r in e) {
      this._freeListsAndStorage[r] = { vtxFreeList: i ? new H(i) : null, idxFreeList: i ? new H(i) : null, vertexBuffers: {}, indexBuffer: i ? new Uint32Array(i) : null };
      for (const n in e[r])
        this._freeListsAndStorage[r].vertexBuffers[n] = { data: i ? fe(i, e[r][n]) : null, stride: e[r][n] };
    }
  }
  static fromTileData(e, t) {
    var h;
    const s = Kt(e), i = [0, 0, 0, 0, 0], r = [0, 0, 0, 0, 0];
    ...
    const n = new ze(s, e.tileDisplayData.displayList, t, void 0), a = ((h = e.tileBufferData) == null ? void 0 : h.geometries) ?? [];
    for (let l = 0; l < a.length; ++l) {
      const d = i[l], c = r[l], u = a[l], f = P[l], m = n._storageFor(f), p = a[l].indexBuffer;
      m.indexBuffer = p, m.idxFreeList = new H(p.length), m.idxFreeList.allocate(c);
      let g = 0;
      for (const _ in u.vertexBuffer) {
        const x = a[l].vertexBuffer[_];
        m.vertexBuffers[_].data = x.data, m.vertexBuffers[_].stride = x.stride;
        const R = N(x.stride), j = x.data.length * R / x.stride;
        g || (g = j);
      }
      m.vtxFreeList = new H(g), m.vtxFreeList.allocate(d);
    }
    return n;
  }
  delete(e) {
    const t = P[e.geometryType];
  ...
  setMeshData(e, t, s, i, r) {
    ...
    let l, d, c, u = !0;
    if (e.indexFrom === void 0 ? (l = r, c = t.indexCount, d = this._allocateIndices(n, c)) : t.indexCount > e.indexCount ? (l = this._displayList.removeFromList(e), this._freeIndices(n, e.indexFrom, e.indexCount), c = t.indexCount, d = this._allocateIndices(n, c)) : t.indexCount === e.indexCount ? (u = !1, d = e.indexFrom, c = e.indexCount) : (l = this._displayList.removeFromList(e), this._freeIndices(n, e.indexFrom + t.indexCount, e.indexCount - t.indexCount), d = e.indexFrom, c = t.indexCount), a !== -1 && d !== -1) {
      const f = this._storageFor(n);
      if (le(a, d, f.vertexBuffers, f.indexBuffer, t, s, i), e.vertexFrom = a, e.indexFrom = d, e.vertexCount = t.vertexCount, e.indexCount = t.indexCount, this._dirtyMap) {
        this._dirtyMap.markDirtyIndices(e.geometryType, e.indexFrom, e.indexCount);
        for (const m in s)
          this._dirtyMap.markDirtyVertices(e.geometryType, m, e.vertexFrom, e.vertexCount);
      }
      return u && this._displayList.addToList(e, l), !0;
    }
    return a !== -1 && this._freeVertices(n, a, h), d !== -1 && this._freeIndices(n, d, c), e.setMeshDataFromBuffers(t, s, i), e.vertexFrom = void 0, e.vertexCount = 0, e.indexFrom = void 0, e.indexCount = 0, !1;
  }
  tryAddMeshData(e, t) {
    const s = t.vertexBuffer, i = t.indexBuffer, r = P[e.geometryType], n = this._allocateVertices(r, e.vertexCount);
    if (n === -1)
    ...
    if (le(n, a, h.vertexBuffers, h.indexBuffer, e, s, i), e.vertexFrom = n, e.indexFrom = a, this._dirtyMap) {
      this._dirtyMap.markDirtyIndices(e.geometryType, e.indexFrom, e.indexCount);
      for (const l in s)
  ...
  _allocateVertices(e, t) {
    var n, a;
    const s = this._storageFor(e), i = (n = s.vtxFreeList) == null ? void 0 : n.allocate(t);
    if (i == null || i === -1)
      return -1;
    const r = (a = s.vtxFreeList) == null ? void 0 : a.fragmentation;
    return r == null || r > we ? -1 : i;
  }
  _freeVertices(e, t, s) {
    var r;
    (r = this._storageFor(e).vtxFreeList) == null || r.free(t, s);
  }
  _freeIndices(e, t, s) {
    var r;
    (r = this._storageFor(e).idxFreeList) == null || r.free(t, s);
  }
  _allocateIndices(e, t) {
    var n, a;
    const s = this._storageFor(e), i = (n = s.idxFreeList) == null ? void 0 : n.allocate(t);
    if (i == null || i === -1)
      return -1;
  ...
  constructor(e) {
    this.geometryMap = mt(() => ({ indexBuffer: be.createIndex(e, vt.STATIC_DRAW), vao: null }), (t, s) => ({ vertexBuffer: be.createVertex(e, yt[s]) }));
  }
  dispose() {
    var e, t, s;
    for (let i = 0; i < 5; i++) {
      const r = this.geometryMap[i];
      if (r) {
        (e = r.data.vao) == null || e.disposeVAOOnly(), (t = r.data.indexBuffer) == null || t.dispose();
        for (const n in r.buffers)
          (s = r.buffers[n]) == null || s.data.vertexBuffer.dispose();
      }
    }
  }
  get(e) {
    ...
    return { getVAO(s, i, r) {
      if (!t.data.vao) {
        ...
        t.data.vao = new _t(s, r, i, n, t.data.indexBuffer);
      }
      return t.data.vao;
    } };
  }
  ...
  _uploadVertices(e, t, s, i, r) {
    ...
    if (!a)
      return;
    const { data: h, stride: l } = a;
    if (n.buffers[s] && h.length > 0) {
      const d = l / h.BYTES_PER_ELEMENT;
      i != null && r != null ? n.buffers[s].data.vertexBuffer.setSubData(h, i * d, i * d, (i + r) * d) : n.buffers[s].data.vertexBuffer.setData(h);
    }
  }
  _uploadIndices(e, t, s, i) {
    ...
    if (!r)
      return;
    const n = e.geometries[t].indexBuffer;
    r.data.indexBuffer && n.length > 0 && (s != null && i != null ? r.data.indexBuffer.setSubData(n, s, s, s + i) : r.data.indexBuffer.setData(n));
  }
};
class Et extends bt {
  constructor() {
    super(...arguments), this._data = null, this._displayList = null, this._lastCommitTime = 0, this._hasData = !1, this._invalidated = !1, this._wglBuffers = null, this._dirtyMap = new Ce();
  }
  destroy() {
  ...
  patch(e) {
    ...
    !this._data && t && ((i = t.tileDisplayData) != null && i.displayObjects.length) ? (t.tileDisplayData.computeDisplayList(), this._dirtyMap = new Ce(), this._dispRecStore = Te.fromTileData(t, this._dirtyMap), this._data = t, this._dirtyMap.markAllDirty(), this._hasData = !0, e.end && this.ready()) : this._data && (t && ((r = t.tileDisplayData) != null && r.displayObjects.length) || s.length) ? this._doPatchData(e) : e.end && this.ready(), e.end && !this._data && this.clear(), this.requestRender(), this.emit("change");
  }
  commit(e) {
    e.time && e.time === this._lastCommitTime || (this._lastCommitTime = e.time, this.visible && this._data && (this._wglBuffers || (this._wglBuffers = new Ht(e.context)), (this._dirtyMap.hasDirty() || this._invalidated) && (this._invalidated = !1, this._wglBuffers.upload(this._data.tileBufferData, this._dirtyMap), this._displayList = this._data.tileDisplayData.displayList.clone(), this._displayObjects = this._data.tileDisplayData.displayObjects.slice(), this._dirtyMap.markAllClean())));
  }
  clear() {
  ...
  _doPatchData(e) {
    this._invalidated = !0, this._patchData(e) || (this._dirtyMap.markAllDirty(), this._data.reshuffle(), this._dispRecStore = Te.fromTileData(this._data, this._dirtyMap)), this.requestRender();
  }
  _patchData(e) {
    let t = !0;
    const s = e.addOrUpdate && e.addOrUpdate.tileDisplayData && e.addOrUpdate.tileDisplayData.displayObjects || [], i = (e.remove || []).slice();
    for (const a of s)
      a.insertAfter != null && i.push(a.id);
    let r;
    ...
    for (const a of i) {
      ...
      if (h) {
        ...
        for (const l of h.displayRecords)
          this._dispRecStore.delete(l);
        n.displayObjectRegistry.delete(a);
      }
    }
    r != null && r.size && (n.displayObjects = n.displayObjects.filter((a) => !r.has(a.id)));
    for (const a of s) {
      let h, l = n.displayObjectRegistry.get(a.id);
      if (l) {
        const c = l.displayRecords;
        l.set(a), l.displayRecords = c;
        const u = l.displayRecords.length;
        for (let f = 0; f < u; ++f) {
          const m = l.displayRecords[f], p = a.displayRecords[f];
          (f >= a.displayRecords.length || m.geometryType !== p.geometryType || m.symbolLevel !== p.symbolLevel || m.zOrder !== p.zOrder || m.materialKey !== p.materialKey) && (this._dispRecStore.delete(l.displayRecords[f]), f < a.displayRecords.length && (l.displayRecords[f] = void 0));
        }
        l.displayRecords.length = a.displayRecords.length;
      } else {
        let c;
        l = a.copy(), l.displayRecords = [], n.displayObjectRegistry.set(a.id, l);
        const u = n.displayObjects;
        if (l.insertAfter != null)
          if (h = {}, l.insertAfter >= 0) {
            const f = n.displayObjectRegistry.get(l.insertAfter);
            f ? (c = u.indexOf(f) + 1, c < u.length ? u.splice(c, 0, l) : (u.push(l), c = u.length)) : (u.push(l), c = u.length);
          } else
            u.unshift(l), c = 0;
        else
          u.push(l), c = u.length;
        if (h) {
          ...
          for (let p = c - 1; p >= 0 && m < f; --p)
            for (let g = u[p].displayRecords.length - 1; g >= 0 && m < f; --g) {
              const _ = u[p].displayRecords[g], x = n.displayList.getDPInfoType();
              h[x] || (h[x] = _, ++m);
            }
        }
      }
      ...
      for (let c = 0; c < d; ++c) {
        ...
        f ? (f.meshData = u.meshData, f.materialKey = u.materialKey) : (f = u.copy(), f.vertexFrom = void 0, f.indexFrom = void 0, l.displayRecords[c] = f);
        const m = u.geometryType, p = n.displayList.getDPInfoType(), g = e.addOrUpdate.tileBufferData.geometries[m], _ = g.vertexBuffer, x = g.indexBuffer;
        let R;
        h && (R = h[p] ? n.displayList.splitAfter(h[p]) : -1), t = this._dispRecStore.setMeshData(f, u, _, x, R) && t, h && f.indexFrom != null && f.indexFrom != null && (h[p] = f);
      }
    }
    return t;
  }
  ...
  static deserialize(e) {
    ...
    for (let s = 0; s < se; ++s) {
      ...
      for (const i in e.geometries[s].vertexBuffer)
        t.geometries[s].vertexBuffer[i] = { data: Q(e.geometries[s].vertexBuffer[i].data, e.geometries[s].vertexBuffer[i].stride), stride: e.geometries[s].vertexBuffer[i].stride };
    }
    return t;
  }
  serialize() {
...
let qt = class $e {
  ...
  replay(e, t, s) {
    for (const i of this.symbolLevels)
      for (const r of i.zLevels) {
        ...
        if (n)
          for (const a of n) {
            const { geometryType: h, materialKey: l, indexFrom: d, indexCount: c } = a, u = Tt.load(l).symbologyType, f = e.painter.getBrush(h, u), m = { geometryType: h, materialKey: l, indexFrom: d, indexCount: c, target: t.getGeometry(h) };
            f.prepareState(e), f.drawGeometry(e, t, m, s);
          }
      }
  }
  get empty() {
  ...
  _addToList(e, t) {
    ...
    if (a !== null && a.materialKey === e.materialKey && a.indexFrom + a.indexCount === e.indexFrom && a.geometryType === e.geometryType)
      ...
      const h = new re();
      h.indexFrom = e.indexFrom, h.indexCount = e.indexCount, h.materialKey = e.materialKey, h.geometryType = e.geometryType, E(r, n + 1, 0, h);
    }
  }
  _removeFromList(e) {
    ...
    if (n !== void 0) {
      ...
      if (e.indexFrom === a.indexFrom)
        return a.indexCount -= e.indexCount, a.indexFrom += e.indexCount, a.indexCount === 0 && E(i, n, 1), n - 1;
      if (e.indexFrom + e.indexCount === a.indexFrom + a.indexCount)
        return a.indexCount -= e.indexCount, a.indexCount === 0 ? (E(i, n, 1), n - 1) : n;
      {
        const h = a.indexFrom, l = e.indexFrom - a.indexFrom, d = e.indexCount, c = a.indexFrom + a.indexCount - (e.indexFrom + e.indexCount);
        a.indexCount = l;
        const u = new re();
        return u.geometryType = a.geometryType, u.materialKey = a.materialKey, u.indexFrom = h + l + d, u.indexCount = c, E(i, n + 1, 0, u), n;
      }
    }
    return null;
  }
  _getDisplayList(e, t) {
    ...
    let r;
    s || (s = new pe(), s.symbolLevel = e, this.symbolLevels.push(s));
    ...
    return r || (r = new Zt(), r.geometryDPInfo = new J(), r.zLevel = t, s.zLevels.push(r)), r.geometryDPInfo.unified || (r.geometryDPInfo.unified = []), r.geometryDPInfo.unified;
  }
  getDPInfoType() {
    return "unified";
  }
...
let Fe = class {
  ...
  constructor(e, t, s, i = 0, r = 0) {
    this.id = e, this.geometryType = t, this.materialKey = s, this.minZoom = i, this.maxZoom = r, this.meshData = null, this.symbolLevel = 0, this.zOrder = 0, this.vertexFrom = 0, this.vertexCount = 0, this.indexFrom = 0, this.indexCount = 0, this._sortKey = null;
  }
  get sortKey() {
  ...
  copy() {
    const e = new ce(this.id, this.geometryType, this.materialKey);
  ...
  readMeshDataFromBuffers(e, t) {
    ...
    for (const s in e) {
      const i = e[s].stride, r = e[s].data, n = [], a = N(i);
  ...
  writeMeshDataToBuffers(e, t, s, i) {
    if (this.meshData) {
      for (const r in t) {
        const n = t[r].stride, a = this.meshData.vertexData.get(r), h = t[r].data, l = N(n);
  ...
  static deserialize(e, t) {
    const s = e.readInt32(), i = e.readInt32(), r = new ce(t.id, s, i);
...
let Ue = class X {
  ...
  serialize(e) {
    return e.push(this.id), Pe(e, this.displayRecords), e;
  }
  static deserialize(e) {
    const t = e.readInt32(), s = new X(t), i = { id: t };
    return s.displayRecords = Nt(e, he, i) ?? [], s;
  }
};
class V {
  constructor() {
  ...
  serialize(e) {
    return Pe(e, this.displayObjects), e;
  }
...
class z {
  ...
  static decode(e) {
    const t = Q(e.data, e.stride), s = e.stride;
    return new z(t, s);
  }
  static fromVertexVector(e) {
    const t = Q(e.data.buffer(), e.stride), s = e.stride;
    return new z(t, s);
  }
}
class A {
  ...
  static decode(e) {
    ...
    for (const r in e.namedBuffers)
      i[r] = z.decode(e.namedBuffers[r]);
    return new A(t, s, i);
  }
  static fromVertexData(e, t) {
    const s = e.indices, i = Q(e.vertices, e.stride), r = e.stride, n = { geometry: new z(i, r) };
    return new A(t, s, n);
  }
  static fromVertexVectors(e) {
    const t = e.geometryType, s = e.indexVector.buffer(), i = {};
    let r;
    for (r in e.namedVectors)
      i[r] = z.fromVertexVector(e.namedVectors[r]);
    return new A(t, s, i);
  }
}
class Yt {
...
let Xt = class {
  constructor(e, t, s) {
    this.geometryType = e, this.indexVector = new Y(Uint32Array, 6 * t), this.namedVectors = {};
    const i = gt(e, s);
    for (const r in i) {
      const n = i[r];
      let a;
      switch (n % 4) {
        case 0:
        case 2:
          a = new Y(Uint32Array, n * t);
          break;
        case 1:
        case 3:
          a = new Y(Uint8Array, n * t);
      }
      this.namedVectors[r] = new Yt(a, n);
    }
  }
  get(e) {
  ...
  transfer(e, t) {
    ...
    let r;
    for (r in t.push(s), this.namedVectors) {
...
const q = new Ae(), S = new Ae(), Qt = 5;
function Wt(o, e) {
  const t = {};
  for (const s in o) {
    const i = { data: fe(e, o[s]), stride: o[s] };
    t[s] = i;
  }
  return t;
}
...
class w {
  ...
  reshuffle() {
    var n, a, h;
    if (q.reset(), !this.tileDisplayData)
      return;
    const e = es(this.tileDisplayData.displayObjects);
    for (const l of e)
      for (const d of l)
        d && q.needMore(d.geometryType, d.meshData ? d.meshData.vertexCount : d.vertexCount, d.meshData ? d.meshData.indexData.length : d.indexCount);
    const t = e.length, s = new ie();
    for (let l = 0; l < t; ++l) {
      s.geometries[l].indexBuffer = new Uint32Array(Math.round(me * q.indicesFor(l)));
      const d = [], c = (n = this.tileBufferData) == null ? void 0 : n.geometries[l].vertexBuffer;
      if (!c)
        continue;
      for (const p in c)
        d.push(c[p].stride);
      const u = w._computeVertexAlignment(d), f = Math.round(me * q.verticesFor(l)), m = w._align(f, u);
      for (const p in c) {
        const g = c[p].stride;
        s.geometries[l].vertexBuffer[p] = { stride: g, data: fe(m, g) };
      }
    }
    ...
    for (let l = 0; l < t; ++l) {
      ...
      for (const c of d) {
        if (c.meshData)
          c.writeMeshDataToBuffers(S.verticesFor(l), s.geometries[l].vertexBuffer, S.indicesFor(l), s.geometries[l].indexBuffer), c.meshData = null;
        else {
          const u = (h = this.tileBufferData) == null ? void 0 : h.geometries[l];
          if (u) {
            const f = u.vertexBuffer, m = u.indexBuffer, p = s.geometries[l].vertexBuffer, g = s.geometries[l].indexBuffer, _ = S.verticesFor(l), x = S.indicesFor(l);
            le(_, x, p, g, c, f, m), c.vertexFrom = _, c.indexFrom = x;
          }
        }
    ...
    if (i)
      for (const l of r)
        i.addToList(l.displayRecords);
    this.tileBufferData = s;
  }
  getStrides() {
    var s;
    const e = [], t = (s = this.tileBufferData) == null ? void 0 : s.geometries;
    if (!t)
      return e;
    for (let i = 0; i < t.length; ++i) {
      const r = t[i];
      e[i] = {};
      for (const n in r.vertexBuffer)
        e[i][n] = r.vertexBuffer[n].stride;
    }
    return e;
  }
  clone() {
    var t, s;
    const e = new w();
    return e.tileBufferData = ((t = this.tileBufferData) == null ? void 0 : t.clone()) ?? null, e.tileDisplayData = ((s = this.tileDisplayData) == null ? void 0 : s.clone()) ?? null, e;
  }
  _guessSize() {
    var n;
    const e = ((n = this.tileDisplayData) == null ? void 0 : n.displayObjects) ?? [], t = Math.min(e.length, 4), s = 12, i = 40;
    let r = 0;
    for (let a = 0; a < t; a++)
      r = Math.max(r, e[a].displayRecords.length);
    return 2 * (e.length * s + e.length * r * i);
  }
  serialize() {
    const e = this.tileBufferData.serialize(), t = this.tileBufferData.getBuffers(), s = this.tileDisplayData.serialize(new Y(Int32Array, this._guessSize())).buffer();
  ...
  static fromVertexData(e, t) {
    ...
    return xt((r) => {
      const n = e.data[r];
      if (n != null) {
        const a = Dt.from(n.records).getCursor();
        for (; a.next(); ) {
          const h = a.id, l = a.materialKey, d = a.indexFrom, c = a.indexCount, u = a.vertexFrom, f = a.vertexCount, m = i.get(h), p = new he(h, r, l);
          p.indexFrom = d, p.indexCount = c, p.vertexFrom = u, p.vertexCount = f, m.displayRecords.push(p);
        }
        s[r] = A.fromVertexData(n, r);
      } else
        s[r] = new Xt(r, 0, Me.DEFAULT).intoBuffers();
    }), w.fromMeshData({ displayObjects: t, vertexBuffersMap: s });
  }
  static fromMeshData(e) {
    const t = new w(), s = new V(), i = new ie();
    s.displayObjects = e.displayObjects;
    for (const r in e.vertexBuffersMap) {
      const n = r, a = e.vertexBuffersMap[n];
      i.geometries[n].indexBuffer = a.indexBuffer, i.geometries[n].vertexBuffer = a.namedBuffers;
    }
  ...
  static create(e, t) {
    ...
    for (const l of e)
      for (const d of l.displayRecords)
        n[d.geometryType].push(d), i[d.geometryType] += d.meshData.vertexCount, r[d.geometryType] += d.meshData.indexData.length;
    const a = new ie(), h = Jt(t);
    for (let l = 0; l < Qt; l++) {
      const d = new Uint32Array(r[l]), c = Wt(h[l], i[l]);
      he.writeAllMeshDataToBuffers(n[l], c, d), a.geometries[l] = { indexBuffer: d, vertexBuffer: c };
    }
...
function ts(o, e) {
  ...
  if (!t)
    return null;
  const [s, i] = t.valid;
  return o[2] > i ? [D([o[0], o[1], i, o[3]]), D([s, o[1], s + o[2] - i, o[3]])] : o[0] < s ? [D([s, o[1], o[2], o[3]]), D([i - (s - o[0]), o[1], i, o[3]])] : null;
}
function ss(o) {
...
function rs(o) {
  ...
  return new Ve({ rings: [[[e, t], [e, i], [s, i], [s, t], [e, t]]], spatialReference: r });
}
class W extends Mt {
  static from(e, t, s) {
    const i = Lt.createInstance(), r = [], n = e.filter((a) => !!a.geometry);
    for (const a of n) {
      const h = ue(a.geometry);
      $t(r, [a], h, !1, !1, t);
    }
    return new W(i, r, s);
  }
  ...
  copy() {
    const e = new W(this.instance, this._features, this._transform);
    return this.copyInto(e), e;
  }
}
const G = new Le(), ne = new Le(), Re = "esriGeometryPolyline";
function Se(o) {
  o.coords.length = 0, o.lengths.length = 0;
}
class B {
  constructor() {
    this.bounds = D(), this.graphic = null;
  }
  static acquire(e = null, t, s, i, r) {
    let n;
    return B._pool.length === 0 ? n = new B() : (n = B._pool.pop(), this._set.delete(n)), n.acquire(e, t, s, i, r), n;
  }
  static release(e) {
  ...
  static getCentroidQuantized(e, t) {
    if (ae(e.geometry)) {
      ...
      if (s == null)
        return null;
      if ((s == null ? void 0 : s.layers.length) > 0 && s.layers.some((i) => i.type === "text" || i.type === "marker")) {
        const i = je(e.geometry);
        return i !== null ? jt(t, {}, { x: i[0], y: i[1] }, !1, !1) : null;
      }
    }
    return null;
  }
    ...
    switch (n) {
      case "esriGeometryPolygon": {
        ...
        if (!h || h.length === 0)
          return null;
        let l;
        if (l = h.length === 1 && h[0].length === 2 ? $(e, { paths: [[h[0][0], h[0][1]]] }) : $(e, this.geometry), !l) {
          const d = { x: h[0][0][0], y: h[0][0][1] };
          if (l = $(e, d), l) {
            const { x: c, y: u } = l;
            return { rings: [[[c - 1, u], [1, -1], [1, 1], [-1, 1], [-1, -1]]] };
          }
        }
        return l;
      }
      case "esriGeometryPolyline": {
        const a = r;
        Se(G), Se(ne);
        const h = a.hasZ ?? !1, l = a.hasM ?? !1;
        return Gt(G, a), Ot(ne, G, h, l, Re, e.scale[0]), Pt(G, ne, h, l, Re, e), Ut(G, a.hasZ ?? !1, a.hasM ?? !1);
      }
      case "esriGeometryMultipoint": {
        const a = r, h = 0.5 * i * Math.max(Math.abs(this.size[0]) + this.size[2] - this.size[0], Math.abs(this.size[1]) + this.size[3] - this.size[1]), l = U(s);
        let d = a.points;
        if (l) {
          const [c, u] = l.valid, f = u - c;
          d = d.filter((m) => {
            if (m[0] + h > u || m[0] - h < c) {
              const p = [...m];
              return m[0] + h > u ? p[0] -= f : p[0] += f, ee(t, m, h) || ee(t, p, h);
            }
            return ee(t, m, h);
          });
        }
        return d.length === 0 ? { points: d } : $(e, { points: d });
      }
    }
    return $(e, this.geometry);
  }
}
B._pool = [], B._set = /* @__PURE__ */ new Set();
const O = { minX: 0, minY: 0, maxX: 0, maxY: 0 }, M = D(), Ie = 1e-5;
...
class os {
  constructor(e, t, s, i, r, n, a) {
    this._graphics = i, this._onAdd = r, this._onRemove = n, this._hashToCIM = a, this._index = ke(9, ns), this._itemByGraphic = /* @__PURE__ */ new Map(), this._inflatedSizeHelper = new ve(), this._tileInfoView = e, this._uidFieldName = s;
    const h = e.getClosestInfoForScale(t);
    h && (this._resolution = this._tileInfoView.getTileResolution(h.level));
  }
  setResourceManager(e) {
    this._cimResourceManager = e, this._hittestDrawHelper = new lt(e);
  }
  hitTest(e, t, s, i, r) {
    var m;
    e = Vt(e, this._tileInfoView.spatialReference);
    const n = 0.5 * i * window.devicePixelRatio * s;
    M[0] = e - n, M[1] = t - n, M[2] = e + n, M[3] = t + n;
    const a = 0.5 * i * (s + F), h = Z(this._index, e - a, t - a, e + a, t + a);
    if (!h || h.length === 0)
      return [];
    const l = [], d = D(), c = D();
    for (const p of h) {
      const { geometry: g, symbolResource: _ } = p;
      this._getSymbolBounds(d, _, g, c, r), c[3] = c[2] = c[1] = c[0] = 0, Ke(d, M) && ((m = p.graphic) != null && m.visible) && l.push(p);
    }
    if (l.length === 0)
      return [];
    const u = this._hittestDrawHelper, f = [];
    for (const p of l) {
      const { geometry: g, symbolResource: _ } = p, { hash: x, textInfo: R } = _, j = this._hashToCIM.get(x);
      j && u.hitTest(M, j.symbol, g, R, r, i) && f.push(p);
    }
    return f.sort(as), f.map((p) => p.graphic);
  }
  getGraphicsData(e, t, s) {
    ...
    let r, n = 0, a = 0;
    const h = t.resolution, l = [], d = { originPosition: "upperLeft", scale: [h, h], translate: [t.bounds[0], t.bounds[3]] };
    for (const c of s) {
      for (a = -2; n < i.length; )
      ...
      if (!(r != null && r.geometry) || a === -2)
        continue;
      const u = r.getGeometryQuantized(d, t.bounds, this._tileInfoView.spatialReference, h), f = { ...r.graphic.attributes };
      f[this._uidFieldName] = c.uid, r.groupId == null && (r.groupId = e.createTemplateGroup(r.symbol, null)), l.push({ centroid: B.getCentroidQuantized(r, d), geometry: u, attributes: f, symbol: r.symbol, groupId: r.groupId, insertAfter: a, zorder: r.zorder });
    }
  ...
  addOrModify(e, t, s) {
    ...
    const i = [0, 0, 0, 0], r = this._getSymbolBounds(null, t, s, i, 0), n = B.acquire(e, t, s, r ?? null, i);
  ...
  remove(e) {
    ...
    this._onRemove(e);
    const t = this._itemByGraphic.get(e);
    t != null && t.bounds && this._index.remove(t), this._itemByGraphic.delete(e);
  }
  updateZ() {
  ...
  update(e, t, s) {
    ...
    return n != null && i.set(e, t, s, n, i.size), s && this._index.insert(i), { oldBounds: r, newBounds: i.bounds };
  }
  updateLevel(e) {
    ...
    for (const [i, r] of t) {
      ...
      r.geometry && n != null && (r.bounds = n, s.push(r));
    }
    this._index.load(s);
  }
  clear() {
  ...
  _createTileGraphics(e, t, s, i, r) {
    const n = this._uidFieldName, a = this._tileInfoView.spatialReference, { bounds: h, resolution: l } = r;
    let d, c, u, f;
    s.sort((m, p) => m.zorder - p.zorder);
    for (let m = 0; m < s.length; m++) {
      u = s[m], d = u.graphic, c = u.getGeometryQuantized(i, h, a, l), f = m === 0 ? -1 : s[m - 1].graphic.uid;
      const p = { ...u.graphic.attributes };
      p[n] = d.uid, u.groupId == null && (u.groupId = t.createTemplateGroup(u.symbol, null)), e.push({ centroid: B.getCentroidQuantized(u, i), geometry: c, attributes: p, symbol: u.symbol, groupId: u.groupId, insertAfter: f, zorder: u.zorder });
    }
  }
  _searchForItems(e) {
    const t = this._tileInfoView.spatialReference, s = e.bounds, i = U(t);
    if (i && t.isWrappable) {
      const [r, n] = i.valid, a = Math.abs(s[2] - n) < Ie, h = Math.abs(s[0] - r) < Ie;
      if ((!a || !h) && (a || h)) {
        const l = e.resolution;
        let d;
        d = D(a ? [r, s[1], r + l * F, s[3]] : [n - l * F, s[1], n, s[3]]);
        const c = Z(this._index, s[0], s[1], s[2], s[3]), u = Z(this._index, d[0], d[1], d[2], d[3]);
  ...
  _getSymbolBounds(e, t, s, i, r) {
    if (!t || !t.symbol || !s)
      return null;
    if (e || (e = D()), Ee(e, s), !i || i[0] === 0 && i[1] === 0 && i[2] === 0 && i[3] === 0) {
      const { hash: h, textInfo: l } = t, d = this._hashToCIM.get(h);
      if (!d)
        return null;
      i || (i = [0, 0, 0, 0]);
      const c = this._inflatedSizeHelper.getSymbolInflateSize(i, d.symbol, this._cimResourceManager, r, l);
      i[0] = k(c[0]), i[1] = k(c[1]), i[2] = k(c[2]), i[3] = k(c[3]);
    }
    const n = this._resolution, a = ve.safeSize(i);
    return e[0] -= a * n, e[1] -= a * n, e[2] += a * n, e[3] += a * n, e;
  }
}
const as = (o, e) => {
  const t = Be(o.graphic), s = Be(e.graphic);
  return t === s ? e.zorder - o.zorder : t - s;
}, ls = qe("geoscene-2d-graphic-debug");
function oe(o, e, t) {
  let s = t.get(o);
  return s || (s = { tile: e, addedOrModified: [], removed: [] }, t.set(o, s)), s;
}
let b = class extends Ze(Ne(at)) {
  constructor(o) {
    super(o), this._storage = new zt(), this._displayIds = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._tiles = /* @__PURE__ */ new Map(), this._graphicStoreUpdate = !1, this._graphicsSet = /* @__PURE__ */ new Set(), this._matcher = Promise.resolve(null), this._tileUpdateSet = /* @__PURE__ */ new Set(), this._tilesToUpdate = /* @__PURE__ */ new Map(), this._graphicIdToAbortController = /* @__PURE__ */ new Map(), this._attached = !1, this._updatingGraphicsTimer = null, this._hashToExpandedSymbol = /* @__PURE__ */ new Map(), this._hashToExpandedSymbolPromise = /* @__PURE__ */ new Map(), this._hashToCIMSymbolPromise = /* @__PURE__ */ new Map(), this._hashToCIM = /* @__PURE__ */ new Map(), this._processing = !1, this._needsProcessing = !1, this._pendingUpdate = { added: /* @__PURE__ */ new Set(), updated: /* @__PURE__ */ new Set(), removed: /* @__PURE__ */ new Set() }, this.lastUpdateId = -1, this.renderer = null, this.updateRequested = !1, this.defaultPointSymbolEnabled = !0, this.graphicUpdateHandler = this.graphicUpdateHandler.bind(this);
  }
  destroy() {
  ...
  _createMatcher(o, e, t) {
    if (o) {
      const s = De(o), i = Ct({ indexCount: 0, fields: {} }, "feature", o, s);
      this._matcher = Ft(i, e, null, t);
    }
  }
  _createDisplayId(o) {
    let e = this._displayIds.get(o);
    return e || (e = this._storage.createDisplayId(), this._displayIds.set(o, e)), e;
  }
  initialize() {
    this._attributeStore = new At({ type: "local", initialize: (i) => Promise.resolve(this.container.attributeView.initialize(i)), update: (i) => this.container.attributeView.requestUpdate(i), render: () => this.container.requestRender() }, Ye("2d")), this.container.hasHighlight = () => this._attributeStore.hasHighlight;
    const o = (i) => {
    ...
    }, t = new Bt(this.container.getMaterialItems.bind(this.container), this.view.featuresTilingScheme.tileInfo);
    this._graphicStore = new os(this.view.featuresTilingScheme, this.view.state.scale, this.uid, this.graphics, o, e, this._hashToCIM), this._meshFactory = new Rt(null, this.uid, t), this._templateStore = t, this.handles.add([Xe(() => this._effectiveRenderer, (i) => {
      ...
      ls && this.container.enableRenderingBounds(() => this._graphicStore.getAllBounds()), this.graphics.items.length > 0 && this._graphicsChangeHandler({ target: this.graphics, added: this.graphics.items, removed: [], moved: [] }), this.handles.add(this.graphics.on("change", (r) => this._graphicsChangeHandler(r)), "graphics");
      const i = this.container.stage.resourceManager;
      this._createMatcher(this._effectiveRenderer, t, i), this._graphicStore.setResourceManager(i), this._attached = !0, this.notifyChange("updating");
    })]);
  ...
  get updating() {
    var o;
    return !this._attached || this._updatingGraphicsTimer !== null || this._pendingUpdate.added.size > 0 || this._pendingUpdate.removed.size > 0 || this._pendingUpdate.updated.size > 0 || this._tileUpdateSet.size > 0 || this._tilesToUpdate.size > 0 || ((o = this._attributeStore) == null ? void 0 : o.updatingHandles.updating) || this._processing;
  }
  hitTest(o) {
  ...
  graphicUpdateHandler(o) {
    ...
    switch (t) {
      ...
      case "symbol":
        ...
        break;
      case "visible":
        this._setFilterState(e.uid, e.visible), this._attributeStore.sendUpdates();
    }
  }
  setHighlight(o) {
    const e = o.map((t) => this._displayIds.get(t)).filter(Qe);
  ...
  _getIntersectingTiles(o) {
    ...
    if (!e || We(e) === 0 || Je(e) === 0)
      return [];
    const t = ts(e, this.view.spatialReference);
    return t != null ? [.../* @__PURE__ */ new Set([...this.view.graphicsTileStore.boundsIntersections(t[0]), ...this.view.graphicsTileStore.boundsIntersections(t[1])])] : this.view.graphicsTileStore.boundsIntersections(e);
  }
  async _updateTile(o) {
    v(this._controller.signal);
    const e = o.tile, t = this._getGraphicsData(this._templateStore, e, o.addedOrModified), s = await this._processGraphics(e, t);
    return v(this._controller.signal), this._patchTile(e.key, { type: "update", addOrUpdate: s, remove: o.removed, end: !0, clear: !1, sort: !1 }), s;
  }
  _patchTile(o, e) {
  ...
  async _updateGraphics() {
    ...
    try {
      if (!this._graphicStoreUpdate) {
        const d = this.view.state, { resolution: c } = d;
        this._graphicStore.updateLevel(c);
      }
      const r = [], n = new Array(o.length + e.length);
      for (let d = 0; d < t.length; d++) {
        const c = t[d], u = this._getIntersectingTiles(c);
        for (const f of u)
          i = f.id, oe(i, f, s).removed.push(this._displayIds.get(c.uid));
      ...
      for (const d of e) {
        ...
        for (const u of c)
          i = u.id, oe(i, u, s).removed.push(this._displayIds.get(d.uid));
      ...
      for (let d = 0; d < n.length; d++) {
        ...
        for (const u of c)
          i = u.id, oe(i, u, s).addedOrModified.push(h);
      }
      this._graphicStore.updateZ();
      const l = [];
      for (const [d, c] of s)
        l.push(this._updateTile(c));
      await Promise.all(l);
    } catch (r) {
      K(r);
    }
  ...
  _getArcadeInfo(o) {
    ...
    return o.geometry == null ? null : { geometryType: ue(o.geometry), spatialReference: et.fromJSON(o.geometry.spatialReference), fields: e };
  }
  _getSymbolForGraphic(o, e) {
    return v(this._controller.signal), o.symbol != null ? Promise.resolve(o.symbol) : this._effectiveRenderer != null ? this._effectiveRenderer.getSymbolAsync(o, { scale: this.view.state.scale, signal: e != null ? e.signal : null }) : Promise.resolve(this._getNullSymbol(o));
  }
  _getCIMSymbol(o, e, t) {
    ...
    if (i != null) {
      ...
      return r || (r = i.fetchCIMSymbol(t).then((n) => (this._hashToCIM.set(e, n.data), this._hashToCIMSymbolPromise.delete(e), n)).catch((n) => (this._hashToCIMSymbolPromise.delete(e), ye(n), null)), this._hashToCIMSymbolPromise.set(e, r), r);
    }
  ...
  _expandCIMSymbol(o, e, t, s) {
    ...
    if (r)
      return r;
    const n = this.container.stage, a = this._getArcadeInfo(e), h = De(null), l = wt(o, h);
    return r = St(l, a, n.resourceManager, s), this._hashToExpandedSymbolPromise.set(t, r), r.then((d) => (this._hashToExpandedSymbol.set(t, d), this._hashToExpandedSymbolPromise.delete(t), d)), r;
  }
  async _getSymbolResources(o, e) {
    return v(this._controller.signal), this.container.stage ? this._getSymbolForGraphic(o, e).then((t) => {
      if (!t)
        return null;
      const s = t.hash();
      return this._getCIMSymbol(t, s, e).then((i) => i == null ? null : this._expandCIMSymbol(i, o, s, e).then((r) => {
        const n = r.layers.filter((a) => a.type === "text" && typeof a.text == "string");
        if (n && n.length > 0) {
          const a = new Array(n.length);
          for (let l = 0; l < n.length; l++) {
            const d = n[l], c = [], [u] = ht(d.text);
            d.text = u;
          ...
          return this.container.getMaterialItems(a).then((l) => {
            ...
            for (let d = 0; d < n.length; d++) {
              const c = n[d];
              h.set(c.cim, { text: c.text, mosaicItem: l[d].mosaicItem });
            }
    ...
    }).catch((t) => (ye(t), null)) : null;
  }
  async _projectAndNormalizeGeometry(o, e) {
    if (v(this._controller.signal), o.geometry == null || o.geometry.type === "mesh")
      return null;
    let t = o.geometry;
    if (ae(t)) {
      const r = t.rings;
      ...
      v(this._controller.signal), r && (is(r.type) || ss(r.type)) ? t = t.center : t = rs(t);
    }
    await ut(t.spatialReference, this.view.spatialReference);
    const s = ct(t), i = ft(s, t.spatialReference, this.view.spatialReference);
    return i && st(i), i;
  }
  _onTileUpdate(o) {
  ...
  async _addGraphic(o) {
    ...
    try {
      await this._addOrUpdateGraphic(o, t), v(this._controller.signal), this._graphicIdToAbortController.delete(o.uid);
    } catch (s) {
      if (this._graphicIdToAbortController.delete(o.uid), !K(s))
        throw s;
    }
  }
  _updateGraphic(o, e) {
  ...
  _addOrUpdateGraphic(o, e) {
    ...
    const t = this._projectAndNormalizeGeometry(o, e), s = this._getSymbolResources(o, e);
    return Promise.all([t, s]).then(([i, r]) => {
      v(this._controller.signal), this._graphicsSet.has(o) && this._graphicStore.addOrModify(o, r, i);
    });
  }
  _addTile(o) {
    const e = this.view.featuresTilingScheme.getTileBounds(D(), o), t = this.view.featuresTilingScheme.getTileResolution(o.level), s = new Et(o, t, e[0], e[3]);
  ...
  async _addNewTile(o, e) {
    ...
    if (e) {
      ...
      for (const n of s)
        n.geometry && (_e(n.geometry) || te(n.geometry)) && this._wrapPoints(n, r);
    }
    const i = o.key;
  ...
  _setFilterState(o, e) {
    ...
    this._attributeStore.setData(t, 0, 0, s | (e ? pt : 0));
  }
  _getGraphicsData(o, e, t) {
    const s = this.view, i = U(s.spatialReference), r = this._graphicStore.getGraphicsData(o, e, t);
    if (i) {
      const n = Math.round((i.valid[1] - i.valid[0]) / e.resolution);
      for (const a of r)
        a.geometry && (_e(a.geometry) || te(a.geometry)) && this._wrapPoints(a, n);
    }
    return r;
  }
  _wrapPoints(o, e) {
    const t = o.geometry;
    te(t) ? this._wrapMultipoint(t, e) : this._wrapPoint(o, e);
  }
  _wrapMultipoint(o, e) {
    const t = o.points, s = [];
    let i = 0, r = 0;
    for (const [n, a] of t) {
      if (s.push([n + i, a]), i = 0, e === I) {
        const h = 5 * F;
        n + r < h ? (s.push([e, 0]), i = -e) : n + r > I - h && (s.push([-e, 0]), i = e);
      } else
        n + r < -F ? (s.push([e, 0]), i = -e) : n + r > I + F && (s.push([-e, 0]), i = e);
      r += n;
    }
    o.points = s;
  }
  _wrapPoint(o, e) {
    ...
    if (e === I) {
      const s = 5 * F;
      t.x < s ? o.geometry = { points: [[t.x, t.y], [e, 0]] } : t.x > I - s && (o.geometry = { points: [[t.x, t.y], [-e, 0]] });
    } else
      t.x < -F ? o.geometry = { points: [[t.x, t.y], [e, 0]] } : t.x > I + F && (o.geometry = { points: [[t.x, t.y], [-e, 0]] });
  }
  _processGraphics(o, e, t) {
    if (!(e && e.length) || !this._meshFactory)
      return Promise.resolve(null);
    const s = W.from(e, this.uid, o.transform), i = this._meshFactory;
  ...
  _processAnalyzedGraphics(o, e) {
    const t = this._meshFactory, s = e.getSize(), i = e.getCursor(), r = { features: s, records: s, metrics: 0 }, n = new It(o.key.id, r, Me.DEFAULT, !1, !1), a = [];
    for (; i.next(); ) {
      ...
      const u = new Ue(c.displayId);
      u.insertAfter = c.insertAfter, a.push(u), t.writeGraphic(n, i, o.level, this.container.stage.resourceManager);
    }
    const h = o.tileInfoView.tileInfo.isWrappable, l = n.serialize(h);
    if (l.length !== 1)
      return new w();
    const d = l[0].message;
    return w.fromVertexData(d, a);
  }
  ...
  _getNullSymbol(o) {
    const e = o.geometry;
    return ge(e) ? it : ae(e) || xe(e) ? rt : this.defaultPointSymbolEnabled ? nt : null;
  }
...
C([T()], b.prototype, "_effectiveRenderer", null), C([T({ constructOnly: !0 })], b.prototype, "requestUpdateCallback", void 0), C([T()], b.prototype, "container", void 0), C([T({ constructOnly: !0 })], b.prototype, "graphics", void 0), C([T()], b.prototype, "renderer", void 0), C([T()], b.prototype, "updating", null), C([T()], b.prototype, "view", void 0), C([T()], b.prototype, "updateRequested", void 0), C([T()], b.prototype, "defaultPointSymbolEnabled", void 0), b = C([ot("geoscene.views.2d.layers.support.GraphicsView2D")], b);
const Ms = b;
export {
  Ms as o
};
