...
function Js() {
  return import("./geomasync-RYr55Mi7.js").then((t) => (Ue([t], "async"), !0));
}
function Xs(t, e) {
  const n = [];
...
let Kt = null;
function Nn() {
  return Kt || (Kt = ft([import("./geometryEngine-Py_d2ZZc.js"), Promise.resolve().then(() => Wi)]).then(([t, e]) => (Zr = !0, e.setGeometryEngine(t), !0)), Kt);
}
let Wt = null;
function In() {
  return Wt !== null || (Wt = Js().then(() => import("./arcadeAsyncRuntime-tx5Udkhp.js")).then((t) => {
    Ae = t;
    for (const e of dn)
...
let Qt = null;
function Tn() {
  return Qt || (Qt = In().then(() => ft([import("./featureSetUtils-XKSj85xH.js").then((t) => t.f), import("./featuresetbase-Y589dv30.js"), import("./featuresetgeom-g7_xbFzn.js"), import("./featuresetstats-D0tiljOB.js"), import("./featuresetstring-OUkfrC9X.js")]).then(([t, e, n, r, i]) => (si = t, Ae.extend([e, n, r, i]), Ue([e, n, r, i], "async"), Xr = !0, !0))), Qt);
}
function ni(t, e = []) {
