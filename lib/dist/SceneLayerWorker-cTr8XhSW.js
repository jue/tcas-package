import { eg as q, a9 as O } from "./index-h53IWweP.js";
import { p as K, m as Q, y as W } from "./MeshLocalVertexSpace-dLoVni3x.js";
import { m as X } from "./MeshGeoreferencedRelativeVertexSpace-zP27o2Kt.js";
import { n as Z, s as ee } from "./vec32-45NkEqZh.js";
...
function te() {
  return P || (P = new Promise((e) => import("./i3s-H0_rBqMp.js").then((t) => t.i).then(({ default: t }) => {
...
async function we(e) {
  ...
  if (m.type === "georeferenced") {
    const { projectBuffer: l, initializeProjection: g } = await import("./index-h53IWweP.js").then((c) => c.lC);
    await g(i, d), f = new Float64Array(a.length), l(a, i, 0, f, d, 0, f.length / 3);
  } else {
    const { project: l } = await import("./georeference-M8NfS96l.js").then((g) => g.c);
