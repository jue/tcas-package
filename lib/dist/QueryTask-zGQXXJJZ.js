import { aD as h, aC as j, a, b as u, eu as y, c as q, b3 as I, L as v, z as T, g as z, ev as l, b7 as m, b6 as f, H as J } from "./index-O2RTvw_o.js";
import { f as S } from "./utils-4fNQuSlg.js";
import { n as N, s as A } from "./executeForIds-omKdqebO.js";
import { S as C } from "./query-E9l7qcVr.js";
import { a as $ } from "./executeQueryJSON-Yju-NJyU.js";
import { n as U } from "./executeQueryPBF-IU57cjkT.js";
...
let i = class extends I {
  ...
  async featureSetFromJSON(e, t, r) {
    if (!this._queryIs3DObjectFormat(e) || this.infoFor3D == null || !t.features)
      return z.fromJSON(t);
    const { meshFeatureSetFromJSON: o } = await l(import("./meshFeatureSet-0edMwzVS.js").then((s) => s.b), r);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r }, { executeRelationshipQuery: o }] = await l(Promise.all([import("./index-O2RTvw_o.js").then((s) => s.lF), import("./executeRelationshipQuery-b4KE9O_m.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: o }] = await l(Promise.all([import("./index-O2RTvw_o.js").then((s) => s.lF), import("./executeRelationshipQuery-b4KE9O_m.js")]), t);
    return e = r.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), o(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r, fetchAttachments: o, processAttachmentQueryResult: s } = await l(import("./queryAttachments-AKXshHAQ.js"), t), c = S(this.url);
    return s(c, await (this.queryAttachmentsSupported ? r(c, e, t) : o(c, e, t)));
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r } = await l(import("./executeTopFeaturesQuery-rf2ulXha.js"), t);
    return r(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r } = await l(import("./executeForTopIds-9Bfk-ypR.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r } = await l(import("./executeForTopExtents-qUPgCUvT.js"), t);
    return r(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r } = await l(import("./executeForTopCount-iPnkUKhf.js"), t);
    return r(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = h.from(e);
