import { i as r, w as a } from "./WGLContainer-vjbZun5V.js";
import { T as t } from "./color-Xkczoxbf.js";
class h extends r {
  constructor() {
  ...
  prepareRenderPasses(e) {
    const s = e.registerRenderPass({ name: "bitmap", brushes: [a.bitmap], target: () => this.children, drawPhase: t.MAP });
