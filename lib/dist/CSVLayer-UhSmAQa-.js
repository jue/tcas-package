import { a as i, b as o, c as y, e4 as v, M as w, g as S, aC as O, dK as F, z as b, bl as I, cC as q, eN as N, Q as _, a9 as C, cq as J, L as P, aD as l, H as p } from "./index-B7TsCcH6.js";
import { c as j } from "./clientSideDefaults-HooaZVw0.js";
import "vue";
...
let a = class extends v {
  ...
  async _startWorker(e) {
    this._connection = await F("CSVSourceWorker", { strategy: b("feature-layers-workers") ? "dedicated" : "local", signal: e });
    const { url: t, delimiter: s, fields: n, latitudeField: m, longitudeField: f, spatialReference: u, timeInfo: d } = this.loadOptions, c = await this._connection.invoke("load", { url: t, customParameters: this.customParameters, parsingOptions: { delimiter: s, fields: n == null ? void 0 : n.map((g) => g.toJSON()), latitudeField: m, longitudeField: f, spatialReference: u == null ? void 0 : u.toJSON(), timeInfo: d == null ? void 0 : d.toJSON() } }, { signal: e });
    this.locationInfo = c.locationInfo, this.sourceJSON = c.layerDefinition, this.delimiter = c.delimiter;
  }
};
i([o()], a.prototype, "type", void 0), i([o()], a.prototype, "loadOptions", void 0), i([o()], a.prototype, "customParameters", void 0), i([o()], a.prototype, "locationInfo", void 0), i([o()], a.prototype, "sourceJSON", void 0), i([o()], a.prototype, "delimiter", void 0), a = i([y("geoscene.layers.graphics.sources.CSVSource")], a);
function h(e, t) {
  throw new p(t, `CSVLayer (title: ${e.title}, id: ${e.id}) cannot be saved to a portal item`);
}
let r = class extends _ {
  constructor(...e) {
    super(...e), this.geometryType = "point", this.capabilities = j(!1, !1), this.delimiter = null, this.editingEnabled = !1, this.fields = null, this.latitudeField = null, this.locationType = "coordinates", this.longitudeField = null, this.operationalLayerType = "CSV", this.outFields = ["*"], this.path = null, this.spatialReference = C.WGS84, this.source = null, this.type = "csv";
  }
  normalizeCtorArgs(e, t) {
    return typeof e == "string" ? { url: e, ...t } : e;
  }
  load(e) {
    const t = e != null ? e.signal : null, s = this.loadFromPortal({ supportedTypes: ["CSV"], supportsData: !1 }, e).catch(J).then(async () => this.initLayerProperties(await this.createGraphicsSource(t)));
  ...
  clone() {
    throw new p("csv-layer:clone", `CSVLayer (title: ${this.title}, id: ${this.id}) cannot be cloned`);
  }
  async save(e) {
...
i([o({ readOnly: !0, json: { read: !1, write: !1 } })], r.prototype, "capabilities", void 0), i([o({ type: [",", " ", ";", "|", "	"], json: { read: { source: "columnDelimiter" }, write: { target: "columnDelimiter", ignoreOrigin: !0 } } })], r.prototype, "delimiter", void 0), i([o({ readOnly: !0, type: Boolean, json: { origins: { "web-scene": { read: !1, write: !1 } } } })], r.prototype, "editingEnabled", void 0), i([o({ json: { read: { source: "layerDefinition.fields" }, write: { target: "layerDefinition.fields" } } })], r.prototype, "fields", void 0), i([o({ type: Boolean, readOnly: !0 })], r.prototype, "isTable", null), i([I("web-map", "labelsVisible", ["layerDefinition.drawingInfo.labelingInfo", "showLabels"])], r.prototype, "readWebMapLabelsVisible", null), i([o({ type: String, json: { read: { source: "locationInfo.latitudeFieldName" }, write: { target: "locationInfo.latitudeFieldName", ignoreOrigin: !0 } } })], r.prototype, "latitudeField", void 0), i([o({ type: ["show", "hide"] })], r.prototype, "listMode", void 0), i([o({ type: ["coordinates"], json: { read: { source: "locationInfo.locationType" }, write: { target: "locationInfo.locationType", ignoreOrigin: !0, isRequired: !0 } } })], r.prototype, "locationType", void 0), i([o({ type: String, json: { read: { source: "locationInfo.longitudeFieldName" }, write: { target: "locationInfo.longitudeFieldName", ignoreOrigin: !0 } } })], r.prototype, "longitudeField", void 0), i([o({ type: ["CSV"] })], r.prototype, "operationalLayerType", void 0), i([o()], r.prototype, "outFields", void 0), i([o({ type: String, json: { origins: { "web-scene": { read: !1, write: !1 } }, read: !1, write: !1 } })], r.prototype, "path", void 0), i([o({ json: { read: !1 }, cast: null, type: a, readOnly: !0 })], r.prototype, "source", void 0), i([o({ json: { read: !1 }, value: "csv", readOnly: !0 })], r.prototype, "type", void 0), i([o({ json: { read: q, write: { isRequired: !0, ignoreOrigin: !0, writer: N } } })], r.prototype, "url", null), r = i([y("geoscene.layers.CSVLayer")], r);
const $ = r;
export {
  $ as default
};
