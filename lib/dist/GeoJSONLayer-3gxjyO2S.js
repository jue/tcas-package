import { s as j, e as r, d as s, a as b, W as N, X as $, r as O, x as w, M as I, y as m, l as J, ac as R, cV as q, Z as P, dH as S, dM as T, bT as k, dN as D, bt as Q, bQ as Z, bu as G, bF as z, bv as L, bz as V, m as F, dO as f, dP as C, R as g, dQ as B, dI as h, dR as U, dS as W, bY as M, bI as A, dT as X, dU as Y, dV as H, bJ as K, dW as ee, dX as te, B as re, dY as se, dZ as ie, d_ as oe, d$ as ne, e0 as ae, bK as le, e1 as ue, bE as de } from "./index-Ek1MTSEY.js";
import { c as pe } from "./clientSideDefaults-LKtLjX6p.js";
import "vue";
...
let o = class extends T(k(D(Q(Z(G(z(L(V(de))))))))) {
  ...
  async applyEdits(e, t) {
    const i = await import("./editingSupport-4-whPc23.js");
    await this.load();
