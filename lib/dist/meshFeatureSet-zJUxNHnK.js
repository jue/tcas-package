import { a as u, b as m, eN as Ft, cU as Lt, bl as Dt, c as U, bk as ce, cD as He, g0 as Se, bg as Ct, fD as nt, s as x, d8 as k, aT as F, jj as Et, aC as De, jk as D, ce as ae, ch as ve, bh as $, ev as rt, b5 as Ce, az as P, aj as Pt, jl as Ot, H as X, jg as It, fN as _t, fO as Nt, hy as Ut, V as kt, hi as ot, hj as st, eq as ge, bW as Wt, ep as it, i9 as zt, hg as Ht, hn as at, cg as lt, b0 as Vt, e4 as Gt, hH as Bt, dH as Zt, l as Jt, aA as Xt, g as Yt, a9 as qt, m as Kt, bi as Qt, fp as en, fz as Ve } from "./index-HxXrdrYt.js";
import { I as ct, o as $e, r as be, D as tn, O as nn, h as Ee, _ as Pe, R as Oe, a as Ie, j as _e, v as Ne, q as rn, b as Ue, N as ee, g as on, x as Me, w as sn, l as an } from "./georeference-ato9TFZB.js";
import { r as ln } from "./imageUtils-taVEByxa.js";
import { m as ut } from "./MeshGeoreferencedRelativeVertexSpace-L53wWd_5.js";
import { a as cn, e as un, t as pt, p as Re, m as de } from "./MeshLocalVertexSpace-0ZxfEBzd.js";
import { i as pn } from "./earcut-fJT_ZMGO.js";
import { t as ht } from "./Indices-EI5Mlgt1.js";
import { e as Ge } from "./deduplicate-6qWLhLLW.js";
import { o as Be, h as hn, m as fn, i as mn, a as gn } from "./External--i2DtII1.js";
import { e as ke } from "./mat3f64-Hpz0k8AN.js";
import { e as ft } from "./mat4f64-kAXAVCnO.js";
import { c as We } from "./spatialReferenceEllipsoidUtils-ibBSh7CN.js";
var B;
...
async function Dn(e, t, n) {
  const { source: r } = t, { loadGLTFMesh: o } = await rt(import("./loadGLTFMesh-of1-muEa.js"), n), s = await En(r, n);
  Ce(n);
...
let b = M = class extends Vt(Gt.LoadableMixin(Bt(Zt))) {
  ...
  async toBinaryGLTF(e) {
    const t = import("./gltfexport-ZuuzXEcu.js"), n = this.load(), r = await Promise.all([t, n]), { toBinaryGLTF: o } = r[0];
    return o(this, e);
  }
  get memoryUsage() {
    let e = 0;
  ...
  static async createFromGLTF(e, t, n) {
    ...
    const { loadGLTFMesh: r } = await rt(import("./loadGLTFMesh-of1-muEa.js"), n);
