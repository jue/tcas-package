import { a as r, b as t, c as n, Q as p, H as u } from "./index-B7TsCcH6.js";
import "vue";
function o(a) {
  return (i, d, y) => {
    if (!i)
      return null;
    const s = i[0].orientedImageryProperties;
    return (s == null ? void 0 : s[a]) ?? null;
  };
}
