...
import { t as yo } from "./requestImageUtils-qcx4bIKR.js";
import { t as ya, u as ct, N as sr, a as Oe, i as X, n as Me, e as Tt } from "./basicInterfaces-qgybO4Nz.js";
import { y as Br, t as Ca } from "./Indices-A_XcB7ng.js";
import { s as H, H as wa } from "./InterleavedLayout-rjTbPz_2.js";
import { s as Co, _ as wo } from "./sphere-Qkjccl62.js";
import { v as Oa } from "./lineSegment-Cq2ECOk9.js";
...
import { T as ut, E as Ea, e as Ra, b as $a } from "./Texture-v5WxIbZy.js";
...
import { S as Va } from "./quat-JSHGXzum.js";
...
import { n as be } from "./symbolColorUtils-Dy_3TghR.js";
...
function an() {
  if (Qt == null) {
    ...
    Qt = import("./basis_transcoder-sYzrUQO0.js").then((e) => e.b).then(({ default: e }) => e({ locateFile: t }).then((r) => (r.initializeBasis(), delete r.then, r)));
  }
  return Qt;
}
let Qt;
...
Zs.shader = new Gt(Qs, () => import("./SSAOBlur.glsl-Ek_LYKNM.js"));
function Js(t) {
...
rl.shader = new Gt(tl, () => import("./SSAO.glsl-QMufKcRC.js"));
const ol = 2;
function Or(t, e) {
  const r = t.fragment;
...
_t.shader = new Gt(gl, () => import("./DefaultMaterial.glsl-M__2Fs-v.js"));
class ke extends ai {
}
...
jt.shader = new Gt(bl, () => import("./RealisticTree.glsl-BF19cXpp.js"));
