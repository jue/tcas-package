import { e as s, d as o, a as F, aD as P, s as D, bR as R, bv as U, bw as Q, bu as N, bz as q, bS as C, j as S, r as p, aT as G, dO as m, bG as k, df as V, dI as K, dQ as M, l as f, y as d, aG as z, C as W, bC as Z, az as v, g as B, e4 as J, ed as X, ee as H, ef as Y, aE as h, dR as ee, dT as te, dU as re, dV as b, bJ as se, eg as ie, dZ as oe, dX as ae, B as ne, d_ as le, e1 as de, bE as pe } from "./index-j1oaLRcp.js";
import { A as ye, K as I } from "./SceneService-PkmRTvGa.js";
import { t as ue, l as ce } from "./FetchAssociatedFeatureLayer-d3c29VIs.js";
import { s as j, l as he, u as fe, m as ge } from "./I3SLayerDefinitions-5y86jBPy.js";
import "vue";
...
let i = class extends ye(R(U(Q(N(q(C(pe))))))) {
  ...
  async applyEdits(e, t) {
    const r = await import("./editingSupport-QxeuZxsb.js");
    if (await this.load(), f(this.associatedLayer))
