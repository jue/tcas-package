import { u, m as f, i as p, T as l, c as a, h as o, l as c, a as F, p as m, b as _, x as y, y as b, o as w, d as v, g, j as T, V as A, q as N, A as B, L as E, B as L } from "./BufferView-_ODXD1vX.js";
import { e as U } from "./types-RkIspGI6.js";
class n {
  constructor(e, t) {
    this.layout = e, this.buffer = typeof t == "number" ? new ArrayBuffer(t * e.stride) : t;
    for (const i of e.fieldNames) {
      const r = e.fields.get(i);
      this[i] = new r.constructor(this.buffer, r.offset, this.stride);
    }
  }
  get stride() {
  ...
  copyFrom(e, t, i, r) {
    const s = this.stride;
    if (s % 4 == 0) {
      const h = new Uint32Array(e.buffer, t * s, r * s / 4);
      new Uint32Array(this.buffer, i * s, r * s / 4).set(h);
    } else {
      const h = new Uint8Array(e.buffer, t * s, r * s);
      new Uint8Array(this.buffer, i * s, r * s).set(h);
    }
  }
}
class d {
  ...
  _appendField(e, t, i) {
    const r = t.ElementCount * U(t.ElementType), s = this.stride;
    this.fields.set(e, { size: r, constructor: t, offset: s, optional: i }), this.stride += r, this.fieldNames.push(e);
  }
  alignTo(e) {
  ...
  clone() {
    const e = new d();
    return e.stride = this.stride, e.fields = /* @__PURE__ */ new Map(), this.fields.forEach((t, i) => e.fields.set(i, t)), e.fieldNames = this.fieldNames.slice(), e.BufferType = this.BufferType, e;
  }
}
function M() {
  return new d();
