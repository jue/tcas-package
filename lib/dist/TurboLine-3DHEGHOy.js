import { z as Et, eg as bt } from "./index-B7TsCcH6.js";
import { e as I, n as D } from "./enums-QU6RH5ju.js";
import { $ as pt } from "./definitions-Co8CrS3w.js";
const Mt = 128e3;
let dt = null, gt = null;
async function St() {
  return dt || (dt = Rt()), dt;
...
async function Rt() {
  gt = await (Et("geoscene-csp-restrictions") ? await import("./libtess-asm-1tootz_9.js").then((i) => i.l) : await import("./libtess-zyRNzND3.js").then((i) => i.l)).load({ locateFile: (i) => bt(`geoscene/core/libs/libtess/${i}`) });
}
function $t(x, i) {
