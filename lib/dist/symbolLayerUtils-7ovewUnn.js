import { dq as h, H as a, dr as u, aX as v, ds as p, bh as c } from "./index-HxXrdrYt.js";
import "vue";
let l = b();
function b() {
  return new h(50);
...
async function g(r, i = null) {
  ...
  if (!r.isPrimitive) {
    ...
    if (s !== void 0)
      return s;
    const { fetch: f } = await import("./objectResourceUtils-w7eqkqcf.js").then((m) => m.o), d = await f(e, { disableTextures: !0 }), n = u(d.referenceBoundingBox, c());
    return l.put(e, n), n;
  }
